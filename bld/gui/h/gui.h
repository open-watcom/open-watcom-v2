...
typedef enum gui_control_styles {
    ...
    GUI_STYLE_CONTROL_CHARCOORD_X       = 0x00040000,
    GUI_STYLE_CONTROL_CHARCOORD_Y       = 0x00080000,
    GUI_STYLE_CONTROL_CHARCOORD_H       = 0x00100000,
    GUI_STYLE_CONTROL_CHARCOORD_V       = 0x00200000,
} gui_control_styles;
