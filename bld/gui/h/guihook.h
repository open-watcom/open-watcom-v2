...
extern void GUIMDIResetMenus( gui_window *wnd, gui_window *, int num_menus, gui_menu_struct *menu );
extern void GUISetMDIDeleteMenuItem( void (*func)( unsigned ) );
extern void GUIMDIDeleteMenuItem( unsigned id );
