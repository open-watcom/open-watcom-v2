                     ...
                     GUIEVCALLBACK *gui_call_back, void *extra, bool sys )
{
    ...
    if( sys || DlgModal ) {
        GUICreateDialogSysModal( &DlgControl, num_controls, controls_info );
    } else {
...
void GUIAPI GUIDlgOpenModal( gui_window *parent_wnd, const char *title, gui_text_ord rows, gui_text_ord cols,
                      gui_control_info *controls_info, int num_controls,
...
void GUIAPI GUIDlgOpenSysModal( const char *title, gui_text_ord rows, gui_text_ord cols,
                         gui_control_info *controls_info, int num_controls,
                         GUIEVCALLBACK *gui_call_back, void *extra )
{
