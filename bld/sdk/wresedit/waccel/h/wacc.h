...
extern bool             WMakeClipDataFromAccelEntry( WAccelEntry *entry, char **data, uint_32 *dsize );
extern bool             WMakeAccelEntryFromClipData( WAccelEntry *entry, char *data, uint_32 dsize );
