...
msgpick1( true, false, 0x003E,                         "WM_ACTIVATESHELLWINDOW",         MC_WINDOW,   0L )
msgpick1( true, false, 0x0029,                         "WM_ALTTABACTIVE",                MC_INPUT,    0L )
...
msgpick1( true, false, 0x022C,                         "WM_BEGINDRAG",                   MC_INPUT,    0L )
...
msgpick1( true, false, 0x010A,                         "WM_CONVERTREQUEST",              MC_OTHER,    0L )
msgpick1( true, false, 0x010B,                         "WM_CONVERTRESULT",               MC_OTHER,    0L )
...
msgpick1( true, false, 0x022D,                         "WM_DRAGLOOP",                    MC_INPUT,    0L )
msgpick1( true, false, 0x022F,                         "WM_DRAGMOVE",                    MC_INPUT,    0L )
msgpick1( true, false, 0x022E,                         "WM_DRAGSELECT",                  MC_INPUT,    0L )
...
msgpick1( true, false, 0x022A,                         "WM_DROPOBJECT",                  MC_INPUT,    0L )
...
msgpick1( true, false, 0x0231,                         "WM_ENTERSIZEMOVE",               MC_WINDOW,   0L )
...
msgpick1( true, false, 0x0232,                         "WM_EXITSIZEMOVE",                MC_INPUT,    0L )
msgpick1( true, false, 0x0034,                         "WM_FILESYSCHANGE",               MC_SYSTEM,   0L )
...
msgpick1( true, false, 0x010C,                         "WM_INTERIM",                     MC_OTHER,    0L )
msgpick1( true, false, 0x0035,                         "WM_ISACTIVEICON",                MC_MDI,      0L )
...
msgpick1( true, false, 0x0131,                         "WM_LBTRACKPOINT",                MC_INPUT,    0L )
...
msgpick1( true, false, 0x0213,                         "WM_NEXTMENU",                    MC_INPUT,    0L )
...
msgpick1( true, false, 0x022B,                         "WM_QUERYDROPOBJECT",             MC_INPUT,    0L )
...
msgpick1( true, false, 0x0036,                         "WM_QUERYPARKICON",               MC_WINDOW,   0L )
msgpick1( true, false, 0x0038,                         "WM_QUERYSAVESTATE",              MC_OTHER,    0L )
...
msgpick1( true, false, 0x0009,                         "WM_SETVISIBLE",                  MC_WINDOW,   0L )
...
msgpick1( true, false, 0x0004,                         "WM_SIZEWAIT",                    MC_OTHER,    0L )
...
msgpick1( true, false, 0x0088,                         "WM_SYNCPAINT",                   MC_WINDOW,   0L )
msgpick1( true, false, 0x0089,                         "WM_SYNCTASK",                    MC_OTHER,    0L )
...
msgpick1( true, false, 0x0017,                         "WM_SYSTEMERROR",                 MC_SYSTEM,   0L )
msgpick1( true, false, 0x0118,                         "WM_SYSTIMER",                    MC_SYSTEM,   0L )
...
msgpick1( true, false, 0x0108,                         "WM_YOMICHAR",                    MC_OTHER,    0L )
