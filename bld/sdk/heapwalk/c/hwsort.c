...
#if 0
INT_PTR __export FAR PASCAL ExtendedSortDlgProc( HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam );
#endif
...
#if(0)
INT_PTR FAR PASCAL ExtendedSortDlgProc( HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam )
{
    char        buf[50];
    char        test[50];
    WORD        i;
