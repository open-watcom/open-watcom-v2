...
#ifndef __NT__
WINEXPORT INT_PTR CALLBACK SegMapDlgProc( HWND hwnd, UINT msg, UINT wparam, DWORD lparam );
#endif
WINEXPORT INT_PTR CALLBACK StatDialogDlgProc( HWND hwnd, UINT msg, UINT wparam, DWORD lparam );
