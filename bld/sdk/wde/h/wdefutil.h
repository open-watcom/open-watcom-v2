...
extern Bool     WdeProcessSymbolCombo    ( HWND, UINT, WPARAM, LPARAM,
                                           WdeHashTable *, uint_16, Bool );
extern Bool     WdeProcessHelpSymbolCombo( HWND, UINT, WPARAM, LPARAM,
                                           WdeHashTable *, uint_32, Bool );
...
extern Bool     WdeWinStylesHook         ( HWND, WORD, WPARAM, LPARAM,
                                           DialogStyle );
extern void     WdeAddSymbolToObjectHashTable ( WdeResInfo *, char *,
                                                WdeHashValue );
