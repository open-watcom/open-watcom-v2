...
/****************************************************************************/
extern BOOL    WINEXPORT WdeProgDispatcher  ( ACTION, WdeProgObject *, void *,
                                              void *);
...
/****************************************************************************/
static OBJPTR   WdeMakeProg             ( OBJPTR, RECT *, OBJPTR, DialogStyle,
                                          char *, OBJ_ID );
static OBJPTR   WdeProgressCreate               ( OBJPTR, RECT *, OBJPTR,
...
static BOOL     WdeProgCopyObject       ( WdeProgObject *, WdeProgObject **,
                                          WdeProgObject *);
...
{
    if( handle == NULL ) {
        return( WdeMakeProg( parent, obj_rect, handle,
                              0, "", PROGRESS_OBJ ) );
    } else {
...
BOOL WINEXPORT WdeProgDispatcher ( ACTION act, WdeProgObject *obj,
                                     void *p1, void *p2)
{
    int     i;
...
BOOL WdeProgCopyObject ( WdeProgObject *obj, WdeProgObject **new,
                           WdeProgObject *handle )
{
    if (new == NULL) {
                                         ...
                                         LPARAM lParam )
{
    if( !WdeProcessMouse( hWnd, message, wParam, lParam ) ) {
        return( CallWindowProc( WdeOriginalProgProc,
