...
#define _imged_freethebits( bits, pres, bmp, fflag, oldbmp )    FreeTheBits( bits, bmp, fflag )
...
#define _imged_getthebits( bits, pres, bmp, oldbmp )            (oldbmp = _wpi_selectbitmap( pres, bmp ))
...
#define _imged_freethebits( bits, pres, bmp, fflag, oldbmp )    _wpi_getoldbitmap( pres, bmp )
