...
{
#ifdef TRMEM
    return( _trmem_alloc( size, _TRMEM_WHO( 5 ), memhdl ) );
#else
    return( malloc( size ) );
#endif
}
...
{
#ifdef TRMEM
    return( _trmem_alloc( size, _TRMEM_WHO( 7 ), memhdl ) );
#else
    return( malloc( size ) );
#endif
}
...
{
#ifdef TRMEM
    return( _trmem_alloc( size, _TRMEM_WHO( 8 ), memhdl ) );
#else
    return( malloc( size ) );
#endif
}
...
{
#ifdef TRMEM
    _trmem_free( ptr, _TRMEM_WHO( 11 ), memhdl );
#else
    free( ptr );
#endif
}
...
{
#ifdef TRMEM
    _trmem_free( ptr, _TRMEM_WHO( 13 ), memhdl );
#else
    free( ptr );
#endif
}
...
{
#ifdef TRMEM
    _trmem_free( ptr, _TRMEM_WHO( 14 ), memhdl );
#else
    free( ptr );
#endif
}
...
{
#ifdef TRMEM
    return( _trmem_realloc( ptr, size, _TRMEM_WHO( 16 ), memhdl ) );
#else
    return( realloc( ptr, size ) );
#endif
}
...
{
#ifdef TRMEM
    return( _trmem_realloc( ptr, size, _TRMEM_WHO( 18 ), memhdl ) );
#else
    return( realloc( ptr, size ) );
#endif
}
...
{
#ifdef TRMEM
    return( _trmem_realloc( ptr, size, _TRMEM_WHO( 19 ), memhdl ) );
#else
    return( realloc( ptr, size ) );
#endif
}
