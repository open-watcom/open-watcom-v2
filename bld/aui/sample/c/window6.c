...
static wnd_row AUIAPICALLBACK W6NumRows( a_window wnd )
{
    wnd=wnd;
    return( ArraySize( Stuff ) );
}

static bool    AUIAPICALLBACK W6GetLine( a_window wnd, wnd_row row, wnd_piece piece, wnd_line_piece *line )
{
    wnd=wnd;
...
static void    AUIAPICALLBACK W6Refresh( a_window wnd )
{
    WndSetRepaint( wnd );
}
