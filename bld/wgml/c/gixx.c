            ...
            if( strcmp( "id", attr_name.attname.t ) == 0 ) {
                ...
                if( (hx_lvl == 0) || (hxstring[2] == lvlc) ) {
                    ...
                    if( pgvalue == PGREF_none ) {                // arbitrary string value
                        ...
                        pgtext = MemToStringSafe( attr_val.tok.s, attr_val.tok.l );  // use text instead of pageno
                ...
                if( hxstring[3] == lvlc ) {     // IHx only
                    printseen = true;
                    printtxt = MemToStringSafe( attr_val.tok.s, attr_val.tok.l );
                ...
                if( hx_lvl == 0 || (hxstring[3] == lvlc) ) {// :IREF :IHx
                    seeseen = true;
                    seetext = MemToStringSafe( attr_val.tok.s, attr_val.tok.l );
