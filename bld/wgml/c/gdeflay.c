...
//  layout_work.ix[k].string_font = FONT0; no string_font for :I3
    ...
    layout_work.sl.first = MemAlloc( sizeof( sl_lay_level ) );
    ...
    layout_work.ol.first = MemAlloc( sizeof( ol_lay_level ) );
    ...
    layout_work.ul.first = MemAlloc( sizeof( ul_lay_level ) );
    ...
    layout_work.dl.first = MemAlloc( sizeof( dl_lay_level ) );
    ...
    layout_work.gl.first = MemAlloc( sizeof( gl_lay_level ) );
