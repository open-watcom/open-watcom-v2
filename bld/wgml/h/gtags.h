...
// upper case     length
  ...
  pickg( I1,       2,      gml_dummy,      tag_out_txt, 0 )
  pickg( I2,       2,      gml_dummy,      tag_out_txt, 0 )
  pickg( I3,       2,      gml_dummy,      tag_out_txt, 0 )
  pickg( IH1,      3,      gml_dummy,      tag_out_txt, 0 )
  pickg( IH2,      3,      gml_dummy,      tag_out_txt, 0 )
  pickg( IH3,      3,      gml_dummy,      tag_out_txt, 0 )
