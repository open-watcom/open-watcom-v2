...
extern bool         is_quote_char( int c );
extern bool         is_base_quote_char( int c );
extern bool         is_function_char( int c );
extern bool         is_tag_char( int c );
extern bool         is_tag_att_char( int c );
extern bool         is_lay_att_char( int c );
extern bool         is_id_char( int c );
extern bool         is_label_char( int c );
extern bool         is_su_char( int c );
extern bool         is_macro_char( int c );
extern bool         is_space_tab_char( int c );
extern bool         is_space_tab_dot_char( int c );
extern bool         is_stop_char( int c );
extern bool         is_symbol_char( int c );
