...
extern void df_new_section( unsigned v_start );
...
extern void fb_line_block( line_block * in_line_block, unsigned h_start, unsigned v_start, unsigned h_len, unsigned v_len, bool twice );
