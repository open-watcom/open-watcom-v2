...
IMPLEMENT_DYNAMIC( CQuickDrawFrameWnd, CMDIFrameWnd )

BEGIN_MESSAGE_MAP( CQuickDrawFrameWnd, CMDIFrameWnd )
    ON_WM_CREATE()
END_MESSAGE_MAP()
...
CQuickDrawFrameWnd::CQuickDrawFrameWnd()
{
}

int CQuickDrawFrameWnd::OnCreate( LPCREATESTRUCT lpCreateStruct )
{
