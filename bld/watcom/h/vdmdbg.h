...
BOOL  WINAPI VDMGetThreadContext(LPDEBUG_EVENT,LPVDMCONTEXT); /* obsolete */
BOOL  WINAPI VDMSetThreadContext(LPDEBUG_EVENT,LPVDMCONTEXT); /* obsolete */
...
typedef BOOL  (WINAPI *VDMGETTHREADCONTEXTPROC)(LPDEBUG_EVENT,LPVDMCONTEXT);
typedef BOOL  (WINAPI *VDMSETTHREADCONTEXTPROC)(LPDEBUG_EVENT,LPVDMCONTEXT);
