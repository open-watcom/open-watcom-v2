...
struct S8{
    static volatile unsigned char __far *const __far *some_ptr[ 23 ];// OK
...
struct S8_2{
    struct S8_2{ unsigned __far *const volatile* p; };
};
...
#ifdef COLON_COLON
    static float __far *S16::b[ 17 ];     // can't add members
#endif // COLON_COLON
...
class S18:public U2{            // unions can't be bases
    const volatile long double __far *const volatile __near ***const ***__far ****c;
};
...
union U4{
    ...
    static int func( float __near *a );
};
...
static union{
    public:                     // OK (I think)
        long int volatile __near * __far * __near * __far *some_var2;
