...
class LocalUEnumerationPointer : public LocalPointerBase<UEnumeration> {
public:
    using LocalPointerBase<UEnumeration>::operator*;
    using LocalPointerBase<UEnumeration>::operator->;
    LocalUEnumerationPointer(UEnumeration *p=NULL) : LocalPointerBase<UEnumeration>(p) {}
    LocalUEnumerationPointer(LocalUEnumerationPointer &&src) U_NOEXCEPT : LocalPointerBase<UEnumeration>(src.ptr) {
        src.ptr=NULL;
    }
    ~LocalUEnumerationPointer() { if (ptr != NULL) { uenum_close(ptr); } }
    LocalUEnumerationPointer &operator=(LocalUEnumerationPointer &&src) U_NOEXCEPT {
        return moveFrom(src);
    }
    LocalUEnumerationPointer &moveFrom(LocalUEnumerationPointer &src) U_NOEXCEPT {
        if (ptr != NULL) { uenum_close(ptr); }
        LocalPointerBase<UEnumeration>::ptr=src.ptr;
        src.ptr=NULL;
        return *this;
    }
    void swap(LocalUEnumerationPointer &other) U_NOEXCEPT {
        UEnumeration *temp=LocalPointerBase<UEnumeration>::ptr;
        LocalPointerBase<UEnumeration>::ptr=other.ptr;
        other.ptr=temp;
    }
    friend inline void swap(LocalUEnumerationPointer &p1, LocalUEnumerationPointer &p2) U_NOEXCEPT {
        p1.swap(p2);
    }
    void adoptInstead(UEnumeration *p) {
        if (ptr != NULL) { uenum_close(ptr); }
        ptr=p;
    }
};
...
public:
    using LocalPointerBase<UEnumeration>::operator*;
    using LocalPointerBase<UEnumeration>::operator->;
    explicit LocalUEnumerationPointer(UEnumeration *p=NULL) : LocalPointerBase<UEnumeration>(p) {}
    ~LocalUEnumerationPointer() { uenum_close(ptr); }
    LocalUEnumerationPointer &moveFrom(LocalUEnumerationPointer &src) U_NOEXCEPT {
        if (ptr != NULL) { uenum_close(ptr); }
        LocalPointerBase<UEnumeration>::ptr=src.ptr;
        src.ptr=NULL;
