 ...
 */
    ...
    /* Use the predefined value. */
#elif U_PLATFORM_USES_ONLY_WIN32_API
#   if defined(__BORLANDC__) || U_PLATFORM == U_PF_MINGW || (defined(_MSC_VER) && _MSC_VER>=1600) || defined(__WATCOMC__)
...
#   define U_DECLARE_UTF16(string) u ## string
    ...
    && (U_CHARSET_FAMILY == U_ASCII_FAMILY || (U_PF_OS390 <= U_PLATFORM && U_PLATFORM <= U_PF_OS400 && defined(__UCS2__)))
