...
public:
    ...
    virtual std::size_t WEXPORT getTextLength() {
        return( GUIGetWindowTextLength( _handle ) );
    }
    virtual void WEXPORT getText( char *textbuf, std::size_t length );
    ...
    virtual int WEXPORT getTextExtentX( const char *text ) {
        return( GUIGetExtentX( _handle, text, std::strlen( text ) ) );
    }
    ...
    void WEXPORT invalidateRow( int row ) {
        GUIWndDirtyRow( _handle, (gui_text_ord)row );
    }
    ...
    void WEXPORT drawText( const WPoint &, const char *, std::size_t );
    void WEXPORT drawText( const WPoint &, const char *, std::size_t, Color, Color );
    void WEXPORT drawText( const WPoint &, const char *, std::size_t, WPaintAttr );
    void WEXPORT drawText( int, int, const char *, std::size_t );
    void WEXPORT drawText( int, int, const char *, std::size_t, Color, Color );
    void WEXPORT drawText( int, int, const char *, std::size_t, WPaintAttr );
    ...
    void WEXPORT drawTextExtent( const WPoint &, const char *, std::size_t, Color, Color, int );
    void WEXPORT drawTextExtent( const WPoint &, const char *, std::size_t, WPaintAttr, int );
    void WEXPORT drawTextExtent( const WPoint &, const char *, std::size_t, int );
    void WEXPORT drawTextExtent( int, int, const char *, std::size_t, Color, Color, int );
    void WEXPORT drawTextExtent( int, int, const char *, std::size_t, WPaintAttr, int );
    void WEXPORT drawTextExtent( int, int, const char *, std::size_t, int );
