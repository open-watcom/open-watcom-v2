...
orl_return              OMFENTRY OmfFileInit( omf_handle, orl_file_id, omf_file_handle * );
orl_return              OMFENTRY OmfFileFini( omf_file_handle );
orl_return              OMFENTRY OmfFileScan( omf_file_handle, orl_hash_key, orl_sec_return_func );
...
omf_sec_base            OMFENTRY OmfSecGetBase( omf_sec_handle );
...
const char              * OMFENTRY OmfSecGetClassName( omf_sec_handle );
...
const char              * OMFENTRY OmfSymbolGetName( omf_symbol_handle );
omf_symbol_value        OMFENTRY OmfSymbolGetValue( omf_symbol_handle );
...
const char              * OMFENTRY OmfGroupName( omf_grp_handle );
const char              * OMFENTRY OmfGroupMember( omf_grp_handle, orl_table_index );
