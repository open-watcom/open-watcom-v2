...
vi_pick( VI_KEY( CTRL_BSLASH ),  InvalidKey,          InvalidKey,           InvalidKey,              BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0), BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0) )
vi_pick( VI_KEY( CTRL_CSB ),     InvalidKey,          InvalidKey,           GetCurrentTag,           BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0), BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0) )
vi_pick( VI_KEY( CTRL_CARET ),   InvalidKey,          InvalidKey,           InvalidKey,              BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0), BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0) )
vi_pick( VI_KEY( CTRL__ ),       InvalidKey,          InvalidKey,           InvalidKey,              BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0), BITS(EVENT_MISC,     0, 0, 0, 0, 0, 0) )
