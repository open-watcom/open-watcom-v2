...
PICK(  "CLOCKX",                "SF",   int,          ClockX,                74,                 SETVAR_T_CLOCKX )
PICK(  "CLOCKY",                "SF",   int,          ClockY,                0,                  SETVAR_T_CLOCKY )
...
PICK(  "SPINX",                 "SF",   int,          SpinX,                 68,                 SETVAR_T_SPINX )
PICK(  "SPINY",                 "SF",   int,          SpinY,                 0,                  SETVAR_T_SPINY )
PICK(  "STACKk",                "SF",   int,          StackK,                MIN_STACK_K,        SETVAR_T_STACKK )
PICK(  "STATUSSECtions",        "SF",   short *,      StatusSections,        NULL,               SETVAR_T_STATUSSECTIONS )
