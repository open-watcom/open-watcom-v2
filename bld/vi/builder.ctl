...
#    <CCCMD> obj286/<OWOBJDIR>/vi.exe    "<OWRELROOT>/binw/vi286.exe"
    ...
    <CCCMD> dos386/<OWOBJDIR>/vi.sym     "<OWRELROOT>/binw/"
    ...
    <CCCMD> wini86/<OWOBJDIR>/viw.sym    "<OWRELROOT>/binw/"
    <CCCMD> win386/<OWOBJDIR>/viw32.exe  "<OWRELROOT>/binw/"
    <CCCMD> win386/<OWOBJDIR>/viw32.sym  "<OWRELROOT>/binw/"
    <CCCMD> nt386/<OWOBJDIR>/vi.exe      "<OWRELROOT>/binnt/"
    <CCCMD> nt386/<OWOBJDIR>/vi.sym      "<OWRELROOT>/binnt/"
    <CCCMD> nt386.win/<OWOBJDIR>/viw.exe "<OWRELROOT>/binnt/"
    <CCCMD> nt386.win/<OWOBJDIR>/viw.sym "<OWRELROOT>/binnt/"
    ...
    <CCCMD> os2386/<OWOBJDIR>/vi.sym     "<OWRELROOT>/binp/"
    ...
    <CCCMD> linux386/<OWOBJDIR>/vi.sym   "<OWRELROOT>/binl/"
    ...
    <CCCMD> ntaxp/<OWOBJDIR>/vi.sym      "<OWRELROOT>/axpnt/"
    <CCCMD> ntaxp.win/<OWOBJDIR>/viw.exe "<OWRELROOT>/axpnt/"
    <CCCMD> ntaxp.win/<OWOBJDIR>/viw.sym "<OWRELROOT>/axpnt/"
    ...
    <CCCMD> linuxx64/<OWOBJDIR>/vi.sym   "<OWRELROOT>/binl64/"
