...
static void DoDlgNew( const char *text, char *buff, unsigned buff_len, comp_type type )
{
...
extern  void    DlgNewWithMod( const char *text, char *buff, unsigned buff_len )
{
    DoDlgNew( text, buff, buff_len, COMPLETE_MODULE );
}

extern  void    DlgNewWithSym( const char *text, char *buff, unsigned buff_len )
{
