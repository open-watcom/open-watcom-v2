...
static void     AUICALLBACK FileMenuItem( a_window wnd, gui_ctl_id id, wnd_row row, wnd_piece piece )
{
    address     addr;
    mod_handle  mod;
    bool        has_addr;
...
static int AUICALLBACK FileScroll( a_window wnd, int lines )
{
    int         old_top;
...
static  void    AUICALLBACK FileModify( a_window wnd, wnd_row row, wnd_piece piece )
{
    file_window *file = WndFile( wnd );
    address     addr;
...
static void AUICALLBACK FileNotify( a_window wnd, wnd_row row, wnd_piece piece )
{
    file_window *file = WndFile( wnd );
    address     addr;
...
static  bool    AUICALLBACK FileGetLine( a_window wnd, wnd_row row, wnd_piece piece, wnd_line_piece *line )
{
    size_t      len;
    file_window *file = WndFile( wnd );
    address     addr;
...
static void AUICALLBACK FileRefresh( a_window wnd )
{
    file_window *file = WndFile( wnd );
    address     dotaddr;
    DIPHDL( cue, cueh );
...
static bool AUICALLBACK FileWndEventProc( a_window wnd, gui_event gui_ev, void *parm )
{
    file_window *file = WndFile( wnd );
...
a_window AUICALLBACK WndSrcOpen( void )
{
    mod_handle  mod;
    address     addr;
    DIPHDL( cue, cueh );
