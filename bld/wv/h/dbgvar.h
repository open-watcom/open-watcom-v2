...
//      unless you're manipulating this data structure
    ...
    bool                pushed          : 1;    // has this expression been pushed on ExprSP?
    bool                popped          : 1;    // has this expression been popped off ExprSP?
    bool                buried          : 1;    // versus on the top of the stack
    bool                is_string       : 1;    // is this a natural character string

    bool                have_type       : 1;    // is ->th valid?
    bool                is_sym_handle   : 1;    // versus a character string
    bool                fake_array      : 1;    // not really an array but expanded as such
    bool                value_valid     : 1;    // are the gadget/str fields accurate?

    bool                gadget_valid    : 1;    // are the gadget/str fields accurate?
    bool                standout        : 1;    // draw in standout attribute?
    bool                on_top          : 1;    // draw the on_top indicator?
    bool                on_top_valid    : 1;    // is the on_top field valid?
