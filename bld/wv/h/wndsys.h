...
extern void     WndRedraw( wnd_class wndclass );
...
extern a_window *DbgTitleWndCreate( const char *title, wnd_info *wndinfo, wnd_class wndclass, void *extra, gui_resource *icon, int title_size, bool vdrag );
extern a_window *DbgWndCreate( const char *title, wnd_info *info, wnd_class wndclass, void *extra, gui_resource *icon );
