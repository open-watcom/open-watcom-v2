...
extern unsigned long    RemoteGetLibName( unsigned long lib_hdl, char *buff, unsigned buff_len );
extern unsigned         RemoteGetMsgText( char *buff, unsigned buff_len );
extern unsigned         RemoteMachineData( address addr, unsigned info_type, unsigned in_size,  const void *inp, unsigned out_size, void *outp );
