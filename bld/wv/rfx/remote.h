...
extern error_handle     RemoteFindFirst( const char *, trap_dta *, int, handle_info * );
extern int              RemoteFindNext( trap_dta *, handle_info * );
extern error_handle     RemoteFindClose( handle_info * );
extern error_handle     RemoteConfig( void );
extern char             *RemoteGetFindName( trap_dta * );
extern long             RemoteGetFindAttr( trap_dta * );
extern long             RemoteGetFindSize( trap_dta * );
extern long             RemoteGetFindDate( trap_dta * );
extern long             RemoteGetFindTime( trap_dta * );
