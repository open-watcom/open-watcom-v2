...
void    _INTERNAL __null_int23_exit( void ) {}              /* SIGNAL needs it */
void    _INTERNAL (*__int23_exit)( void ) = __null_int23_exit;
static void _INTERNAL _null_exit_rtn( void ) {}
void    _INTERNAL (*__FPE_handler_exit)( void ) = _null_exit_rtn;
#endif
