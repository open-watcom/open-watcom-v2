...
extern _WCNORETURN void _INTERNAL __exit_with_msg( char _WCI86FAR *, int );
extern _WCNORETURN void _INTERNAL __fatal_runtime_error( char _WCI86FAR *, int );
extern _WCNORETURN void _INTERNAL __exit( int );
