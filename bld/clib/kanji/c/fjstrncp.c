...
/**
*
*  Name:        _fjstrncpy      文字列をコピーする
*
*  Synopsis:    p = _fjstrncpy( to, from, n );
*
*               FJSTRING p;     ｔｏと同じ値
*               FJSTRING to;    コピーされる文字列
*               FJSTRING from;  コピーする文字列
*               int n;          文字数
*
...
_WCRTLINK FJSTRING _WCI86FAR _fjstrncpy( JCHAR _WCFAR *to, const JCHAR _WCFAR *from, size_t n )
{
    int i;
    JCHAR _WCFAR *p;
