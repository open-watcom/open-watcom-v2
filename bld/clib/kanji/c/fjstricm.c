...
/**
*
*  Name:        _fjstricmp              文字列を比較する
*
*  Synopsis:    x = _fjstricmp( a, b );
*
*               int x;          結果
*               FJSTRING a, b;  文字列
*
...
*
*
*  Name:        _fjstricmp      compare strings with mixed KANJI letters
*
*  Synopsis:    x = _fjstricmp( a, b );
*
...
*
*  Description: The _fjstricmp function compares the string pointed to by a
...
_WCRTLINK int _WCI86FAR _fjstricmp( const JCHAR _WCFAR *a, const JCHAR _WCFAR *b )
{
    JMOJI aa, bb;
