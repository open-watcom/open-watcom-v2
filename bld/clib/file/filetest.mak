#
# C library file functions test program makefile (see filetest.c)
#
...
# in that directory, type "wmake -h -f filetest.mak"
...
filetest = $(new_clib)\file\c\filetest.c
...
win_s.exe : $(filetest) windows.lnk
...
win_c.exe : $(filetest) windows.lnk
