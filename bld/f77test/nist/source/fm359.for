...
C****                          VERSION 2.1                              00130359
C****                                                                   00140359
C****                                                                   00150359
C****           SUGGESTIONS AND COMMENTS SHOULD BE FORWARDED TO         00160359
C****          NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY           00170359
C****               SOFTWARE STANDARDS VALIDATION GROUP                 00180359
C****                      BUILDING 225  RM A266                        00190359
C****                     GAITHERSBURG, MD  20899                       00200359
C****                                                                   00210359
C****                                                                   00220359
C****                                                                   00230359
...
C****                                                                   00270359
     ...
     1          ZNAME*20, ZTAPE*10, ZPROJ*13, ZTAPED*13!, REMRKS*31     00290359
CBE** ********************** BBCINITA **********************************00300359
CBB** ********************** BBCINITB **********************************00310359
C**** INITIALIZE SECTION                                                00320359
      DATA  ZVERS,                  ZVERSD,             ZDATE           00330359
     1      /'VERSION 2.1  ',  '93/10/21*21.02.00',  '*NO DATE*TIME'/   00340359
...
CZ04  ZDATE  = 'DATE OF TEST'                                           00460359
CZ05  ZCOMPL = 'COMPILER IDENTIFICATION'                                00470359
CZ06  ZPROJ  = 'PROJECT NUMBER/IDENTIFICATION'                          00480359
CZ07  ZNAME  = 'NAME OF USER'                                           00490359
CZ08  ZTAPE  = 'TAPE OWNER/ID'                                          00500359
CZ09  ZTAPED = 'DATE TAPE COPIED'                                       00510359
C                                                                       00520359
      IVPASS = 0                                                        00530359
      IVFAIL = 0                                                        00540359
      IVDELE = 0                                                        00550359
...
C     I02 CONTAINS THE LOGICAL UNIT NUMBER FOR THE PRINTER.             00630359
      I02 = 06                                                          00640359
C                                                                       00650359
CX010   REPLACED BY FEXEC X-010 CONTROL CARD (CARD-READER UNIT NUMBER). 00660359
...
C                                                                       00700359
CX020   REPLACED BY FEXEC X-020 CONTROL CARD (PRINTER UNIT NUMBER).     00710359
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)04600359
