...
C
      OPEN( UNIT=I01, FILE='fm404.dat', STATUS='OLD', ACTION='READ',
     &      IOSTAT=ISTAT )
      IF( ISTAT .NE. 0 )THEN
         WRITE( I02, * )'Fatal Error opening FM404.DAT'
         STOP
      END IF
C-----------------------------------------------------------------------
C                                                                       00950404
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)02920404
