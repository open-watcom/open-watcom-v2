...
C****                          VERSION 2.1                              00480111
C****                                                                   00490111
C****                                                                   00500111
C****           SUGGESTIONS AND COMMENTS SHOULD BE FORWARDED TO         00510111
C****          NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY           00520111
C****               SOFTWARE STANDARDS VALIDATION GROUP                 00530111
C****                      BUILDING 225  RM A266                        00540111
C****                     GAITHERSBURG, MD  20899                       00550111
C****                                                                   00560111
C****                                                                   00570111
C****                                                                   00580111
...
C****                                                                   00620111
     ...
     1          ZNAME*20, ZTAPE*10, ZPROJ*13, ZTAPED*13                 00640111
      INTEGER*4 ISTAT, JVI  ! For Watcom by Jeff Moss on 30-Jan-2004
CBE** ********************** BBCINITA **********************************00650111
CBB** ********************** BBCINITB **********************************00660111
C**** INITIALIZE SECTION                                                00670111
      DATA  ZVERS,                  ZVERSD,             ZDATE           00680111
     1      /'VERSION 2.1  ',  '93/10/21*21.02.00',  '*NO DATE*TIME'/   00690111
...
CZ04  ZDATE  = 'DATE OF TEST'                                           00810111
CZ05  ZCOMPL = 'COMPILER IDENTIFICATION'                                00820111
CZ06  ZPROJ  = 'PROJECT NUMBER/IDENTIFICATION'                          00830111
CZ07  ZNAME  = 'NAME OF USER'                                           00840111
CZ08  ZTAPE  = 'TAPE OWNER/ID'                                          00850111
CZ09  ZTAPED = 'DATE TAPE COPIED'                                       00860111
C                                                                       00870111
      IVPASS = 0                                                        00880111
      IVFAIL = 0                                                        00890111
      IVDELE = 0                                                        00900111
...
C
      OPEN( UNIT=I01, FILE='fm111.dat', STATUS='OLD', ACTION='READ',
     &      IOSTAT=ISTAT )
      IF( ISTAT .NE. 0 )THEN
         WRITE( I02, * )'Fatal Error opening FM111.DAT'
         STOP
      END IF
C-----------------------------------------------------------------------
C                                                                       01000111
CX010   REPLACED BY FEXEC X-010 CONTROL CARD (CARD-READER UNIT NUMBER). 01010111
...
C                                                                       01050111
CX020   REPLACED BY FEXEC X-020 CONTROL CARD (PRINTER UNIT NUMBER).     01060111
...
70012      FORMAT (1H ,10X,10HCORRECT:  ,                               02000111
     1     43H     0   .0   .0    0   .0E+0   .0   -.4E-2/)             02010111
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)03270111
