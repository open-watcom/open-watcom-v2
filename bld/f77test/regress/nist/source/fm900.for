...
C
      OPEN( UNIT=I01, FILE='fm900.dat', STATUS='OLD', ACTION='READ',
     &      IOSTAT=ISTAT )
      IF( ISTAT .NE. 0 )THEN
         WRITE( I02, * )'Fatal Error opening FM900.DAT'
         STOP
      END IF
C-----------------------------------------------------------------------
C                                                                       01320900
...
70332      FORMAT (1H ,48X,5H   OR)                                     06750900
           WRITE (NUVI,70332)                                           06750900
70333      FORMAT (26X,36H +0.8648D-02 +0.8648E+04   +8647.859/         06750900
     1             26X,36H +0.8648E-02 +0.8648E+04   +8647.859/         06750900
     2             26X,36H +0.8648-002 +0.8648+004   +8647.859)         06750900
...
70352      FORMAT (1H ,48X,5H   OR)                                     07140900
           WRITE (NUVI,70352)                                           07140900
70353      FORMAT (28X,58H   +987.66 +0.0099E+06    +98.76539  +9.88E+0207140900
     1 +8.6479D+02/28X,58H   +987.66 +0.0099E+06    +98.76539  +9.88E+0207140900
     2 +8.6479E+02/28X,58H   +987.66 +0.0099+006    +98.76539  +9.88+00207140900
     3 +8.6479+002)                                                     07140900
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)07880900
