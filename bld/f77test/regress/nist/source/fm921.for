...
C****                          VERSION 2.1                              00300921
C****                                                                   00310921
C****                                                                   00320921
C****           SUGGESTIONS AND COMMENTS SHOULD BE FORWARDED TO         00330921
C****          NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY           00340921
C****               SOFTWARE STANDARDS VALIDATION GROUP                 00350921
C****                      BUILDING 225  RM A266                        00360921
C****                     GAITHERSBURG, MD  20899                       00370921
C****                                                                   00380921
C****                                                                   00390921
C****                                                                   00400921
...
C****                                                                   00520921
     ...
     1          ZNAME*20, ZTAPE*10, ZPROJ*13, ZTAPED*13!, REMRKS*31     00540921
CBE** ********************** BBCINITA **********************************00550921
CBB** ********************** BBCINITB **********************************00560921
C**** INITIALIZE SECTION                                                00570921
      DATA  ZVERS,                  ZVERSD,             ZDATE           00580921
     1      /'VERSION 2.1  ',  '93/10/21*21.02.00',  '*NO DATE*TIME'/   00590921
...
CZ04  ZDATE  = 'DATE OF TEST'                                           00710921
CZ05  ZCOMPL = 'COMPILER IDENTIFICATION'                                00720921
CZ06  ZPROJ  = 'PROJECT NUMBER/IDENTIFICATION'                          00730921
CZ07  ZNAME  = 'NAME OF USER'                                           00740921
CZ08  ZTAPE  = 'TAPE OWNER/ID'                                          00750921
CZ09  ZTAPED = 'DATE TAPE COPIED'                                       00760921
C                                                                       00770921
      IVPASS = 0                                                        00780921
      IVFAIL = 0                                                        00790921
      IVDELE = 0                                                        00800921
...
C     I02 CONTAINS THE LOGICAL UNIT NUMBER FOR THE PRINTER.             00880921
      I02 = 06                                                          00890921
C                                                                       00900921
CX010   REPLACED BY FEXEC X-010 CONTROL CARD (CARD-READER UNIT NUMBER). 00910921
...
C                                                                       00950921
CX020   REPLACED BY FEXEC X-020 CONTROL CARD (PRINTER UNIT NUMBER).     00960921
...
C     I10 CONTAINS THE UNIT NUMBER FOR A DIRECT, UNFORMATTED FILE.      01070921
      I10 = 24                                                          01080921
CX100   REPLACED BY FEXEC X-100 CONTROL CARD (DIR. FILE UNIT NUMBER).   01090921
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)03230921
