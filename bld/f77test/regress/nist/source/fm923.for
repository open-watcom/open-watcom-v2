...
C****                          VERSION 2.1                              00140923
C****                                                                   00150923
C****                                                                   00160923
C****           SUGGESTIONS AND COMMENTS SHOULD BE FORWARDED TO         00170923
C****          NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY           00180923
C****               SOFTWARE STANDARDS VALIDATION GROUP                 00190923
C****                      BUILDING 225  RM A266                        00200923
C****                     GAITHERSBURG, MD  20899                       00210923
C****                                                                   00220923
C****                                                                   00230923
C****                                                                   00240923
...
COL.      1----------------------------------------------------------61 00530923
CARD 24   45                                                            00540923
CARD 25   'CAN''T, AND/OR   WON''T'                                     00600923
CARD 26   '1234567890' '12345678' '1234567890123'                       00610923
CARD 27   TRUCK .FOUR .FALSE. .TWIN. F12. F7.2 .TRUE. .T=3+4            00620923
CARD 28   T T T T T                                                     00630923
CARD 29   F F/F F F                                                     00640923
CARD 30   / 10 20 30                                                    00650923
CARD 31   1 2 3 4                                                       00660923
CARD 32   5 6 7 8                                                       00670923
C*****                                                                  00680923
...
CZ04  ZDATE  = 'DATE OF TEST'                                           00970923
CZ05  ZCOMPL = 'COMPILER IDENTIFICATION'                                00980923
CZ06  ZPROJ  = 'PROJECT NUMBER/IDENTIFICATION'                          00990923
CZ07  ZNAME  = 'NAME OF USER'                                           01000923
CZ08  ZTAPE  = 'TAPE OWNER/ID'                                          01010923
CZ09  ZTAPED = 'DATE TAPE COPIED'                                       01020923
C                                                                       01030923
      IVPASS = 0                                                        01040923
      IVFAIL = 0                                                        01050923
      IVDELE = 0                                                        01060923
...
C
      OPEN( UNIT=I01, FILE='fm923.dat', STATUS='OLD', ACTION='READ',
     &      IOSTAT=ISTAT )
      IF( ISTAT .NE. 0 )THEN
         WRITE( I02, * )'Fatal Error opening FM923.DAT'
         STOP
      END IF
C-----------------------------------------------------------------------
C                                                                       01160923
CX010   REPLACED BY FEXEC X-010 CONTROL CARD (CARD-READER UNIT NUMBER). 01170923
...
C                                                                       01210923
CX020   REPLACED BY FEXEC X-020 CONTROL CARD (PRINTER UNIT NUMBER).     01220923
...
CT023*  TEST 22 - CARD 25    QUOTES, BLANKS, COMMAS AND SLASHES         06130923
...
CT024*  TEST 23 - CARD 26    CHARACTER STRINGS THAT ARE READ IN         06290923
...
CT025*  TEST 24 - CARD 27    LOGICAL VALUES IN DIFFERENT                06490923
...
CT026*  TEST 25 - CARDS 28-29    SLASH TERMINATOR                       06700923
           IVTNUM = 25                                                  06710923
...
CT027*  TEST 26 - CARD 30    SLASH TERMINATING IMPLIED-DO LOOP          06880923
           IVTNUM = 26                                                  06890923
        J1I(1) = 1                                                      06900923
...
CT028*  TEST 27 - CARDS 31-32   SECOND READ SHOULD CAUSE VALUES         07030923
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)07680923
