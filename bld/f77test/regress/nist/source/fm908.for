...
C****                          VERSION 2.1                              00130908
C****                                                                   00140908
C****                                                                   00150908
C****           SUGGESTIONS AND COMMENTS SHOULD BE FORWARDED TO         00160908
C****          NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY           00170908
C****               SOFTWARE STANDARDS VALIDATION GROUP                 00180908
C****                      BUILDING 225  RM A266                        00190908
C****                     GAITHERSBURG, MD  20899                       00200908
C****                                                                   00210908
C****                                                                   00220908
C****                                                                   00230908
...
C**** INITIALIZE SECTION                                                00450908
     ...
     1      /'VERSION 2.1  ',  '93/10/21*21.02.00',  '*NO DATE*TIME'/   00470908
...
CZ04  ZDATE  = 'DATE OF TEST'                                           00590908
CZ05  ZCOMPL = 'COMPILER IDENTIFICATION'                                00600908
CZ06  ZPROJ  = 'PROJECT NUMBER/IDENTIFICATION'                          00610908
CZ07  ZNAME  = 'NAME OF USER'                                           00620908
CZ08  ZTAPE  = 'TAPE OWNER/ID'                                          00630908
CZ09  ZTAPED = 'DATE TAPE COPIED'                                       00640908
C                                                                       00650908
      IVPASS = 0                                                        00660908
      IVFAIL = 0                                                        00670908
      IVDELE = 0                                                        00680908
...
C     I02 CONTAINS THE LOGICAL UNIT NUMBER FOR THE PRINTER.             00760908
      I02 = 06                                                          00770908
C                                                                       00780908
CX010   REPLACED BY FEXEC X-010 CONTROL CARD (CARD-READER UNIT NUMBER). 00790908
...
C                                                                       00830908
CX020   REPLACED BY FEXEC X-020 CONTROL CARD (PRINTER UNIT NUMBER).     00840908
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)09230908
