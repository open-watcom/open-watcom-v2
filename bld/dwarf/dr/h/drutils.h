...
extern bool         DWRWalkChildren( dr_handle mod, const dw_tagnum *tags, DRWLKBLK *wlks, void *d );
extern bool         DWRWalkContaining( dr_handle mod, dr_handle target, DRWLKBLK wlk, void *d );
extern bool         DWRWalkSiblings( dr_handle curr, const dw_tagnum *tags, DRWLKBLK *wlks, void *d );
extern bool         DWRWalkScope( dr_handle mod, const dw_tagnum *tags, DRWLKBLK wlks, void *d );
