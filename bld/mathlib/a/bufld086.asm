...
;<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
        ...
        mov     BP,AX           ; get address of buffer
        ...
        _loop                   ; loop (convert digits into 54-bit int)
          mov   AL,[BP]         ; - get next digit
          cmp   AL,0            ; - quit if at end of buffer
          _quif e               ; - ...

;[]  multiply current value in DX:BX:CX:DI:SI by 10
          ...
          _shl  SI,1            ; - multiply number by 4
          ...
          _shl  SI,1            ; - shift left to make it times 10
          _rcl  DI,1            ; - ...
          _rcl  CX,1            ; - ...
          _rcl  BX,1            ; - ...
          _rcl  DX,1            ; - ...

          mov   AL,[BP]         ; - add in current digit
          and   AX,000Fh        ; - ...
          add   SI,AX           ; - ...
          adc   DI,0            ; - ...
          adc   CX,0            ; - ...
          ...
          inc   BP              ; - point to next digit in buffer
        _endloop                ; endloop
        mov     AX,DX           ; get high order word into AX
        mov     DX,DI           ; set up integer into AX:BX:CX:DX:SI

;[] Turn the integer in AX:BX:CX:DX:SI into a real number
...
Norm    proc    near            ; normalize floating point number
        ...
        _if     ne              ; if number is non-zero
          ...
          _loop                 ; - loop
            ...
            _quif s             ; - - ...
            _shl  SI,1          ; - - shift integer left by 1 bit
            _rcl  DX,1          ; - - ...
            _rcl  CX,1          ; - - ...
            _rcl  BX,1          ; - - ...
            _rcl  AX,1          ; - - ...
