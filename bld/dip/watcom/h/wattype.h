...
extern dip_status       FindTypeHandle( imp_image_handle *, imp_mod_handle im, unsigned index, imp_type_handle *ith );
extern search_result    LookupTypeName( imp_image_handle *, imp_mod_handle im, lookup_item *li, imp_type_handle *ith );
extern search_result    SearchEnumName( imp_image_handle *, imp_mod_handle im, lookup_item *li, void *d );
extern search_result    SearchTypeName( imp_image_handle *, imp_mod_handle im, lookup_item *li, void *d );
...
extern const char       *FindSpecCueTable( imp_image_handle *, imp_mod_handle im, const char **base );
