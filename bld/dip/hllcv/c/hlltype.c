...
search_result hllTypeSearchNestedSym( imp_image_handle *ii, imp_type_handle *it, lookup_item *li, void *d )
{
    lf_all              *p;
...
{
    /* unised parameters */ (void)ii; (void)it; (void)lc; (void)a;
...
{
    /* unised parameters */ (void)ii; (void)it;
