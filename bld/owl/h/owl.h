...
#define OWL_CPUS \
    ...
    OWL_CPU( OWL_CPU_ARM,   EM_ARM,     COFF_IMAGE_FILE_MACHINE_ARMNT ) \
    OWL_CPU( OWL_CPU_A64,   EM_AARCH64, COFF_IMAGE_FILE_MACHINE_ARM64 )
...
typedef enum {
    ...
    OWL_SECTION_COMDAT_CODE     = OWL_SEC_ATTR_COMDAT | OWL_SEC_ATTR_CODE | OWL_SEC_ATTR_PERM_READ | OWL_SEC_ATTR_PERM_EXEC,
    OWL_SECTION_COMDAT_DATA     = OWL_SEC_ATTR_COMDAT | OWL_SEC_ATTR_DATA | OWL_SEC_ATTR_PERM_READ | OWL_SEC_ATTR_PERM_WRITE,
    OWL_SECTION_COMDAT_BSS      = OWL_SEC_ATTR_COMDAT | OWL_SEC_ATTR_BSS | OWL_SEC_ATTR_PERM_READ | OWL_SEC_ATTR_PERM_WRITE,
    OWL_SECTION_COMDAT_DEBUG    = OWL_SEC_ATTR_COMDAT | OWL_SEC_ATTR_DATA | OWL_SEC_ATTR_DISCARDABLE | OWL_SEC_ATTR_PERM_READ,
    OWL_SECTION_COMDAT_PDATA    = OWL_SEC_ATTR_COMDAT | OWL_SEC_ATTR_DATA | OWL_SEC_ATTR_PERM_READ,
} owl_section_type;
