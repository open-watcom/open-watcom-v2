...
:MSGJTXT. "%s"
:WARNING. 1
This is a user message generated by the
.kw #pragma
.kw message
or by
.kw #warning
...
:MSGSYM. ERR_INTERNAL_ERROR_MSG
:MSGTXT. %s
:MSGJTXT. %s
This is a internal error message generated by compiler.

:MSGSYM. ERR_INVALID_BINARY_CONSTANT
:MSGTXT. invalid binary constant
:MSGJTXT.
The constant started with a '0b' prefix which makes it look like a binary
constant but the constant was not followed by valid binary digits.
:errbad.
unsigned i = 0b42;     // invalid binary constant
:eerrbad.
