...
typedef struct directory {
        char    *pathbuff;              /* initial path, current path */
        int     pathbufflen;            /* maximum length of path name */
        char    *mask;                  /* filename mask */
        ORD     currrow;                /* current row on vscreen */
        int     index;                  /* index in current directory */
