...
:MSGATTR. 0
 ...
 argument list.
:MSGSYM. UNUSED AR_ARG_CHAR_MISMATCH
:cmt :MSGTXT. argument number %d1 (%s2) in call to %s3 must be CHARACTER*%u4 or bigger but size passed was %d5
:cmt :MSGJTXT. %s3をCALLする%d1番目の引数(%s2)はCHARACTER*%u4かそれ以上必要です。しかし%d5となっています。
:cmt :MSGATTR. 0
:cmt  Argument number %d1 in the call to subprogram %s3 was declared in the calling
:cmt  subprogram to be CHARACTER*%d4.
:cmt  In subprogram %s3, the argument was declared to be CHARACTER*%d3.
:cmt  The size of the argument, in the calling program, must be greater
:cmt  than or equal to the size in the subroutine/function.
:MSGSYM. UNUSED AR_COD_MISMATCH
:cmt :MSGTXT. argument number %d1 (%s2) in call to %s3 - actual argument was %s4 but dummy argument was %s5
:cmt :MSGJTXT. %s3をCALLする%d1番目の引数(%s2)は実引数が%s4でした。しかし仮引数は%s5でした。
:cmt :MSGATTR. 0
:cmt  Argument number %d1 in the call to subprogram %s3 was a %s4 in the calling
:cmt  subprogram but a %s5 in the called subprogram.
:cmt  This message is issued when, for example, an function name is passed to
:cmt  an array name.
:MSGSYM. UNUSED AR_CODI_MISMATCH
:cmt :MSGTXT. argument number %d1 - %s2 was passed to an intrinsic function
:cmt :MSGJTXT. %d1番目の引数 - %s2が組込み関数に渡されました。
:cmt :MSGATTR. 0
:cmt  Argument number %d1 to an intrinsic function was declared as a %s2 and cannot
:cmt  be specified as an argument to an intrinsic function.
:cmt  For example, it is illegal to pass an array to the SIN intrinsic function.
:cmt  Constants, simple variables, array elements, and substrung array
:cmt  elements may be used as arguments.
:MSGSYM. UNUSED AR_FUN_EXPECT
:cmt :MSGTXT. argument number %d1 (%s2) in call to %s3 - a subroutine was passed but a function was expected
:cmt :MSGJTXT. %s3へのCALLの%d1番目の引数(%s2) - ｻﾌﾞﾙｰﾁﾝが渡されましたが,関数でなければなりません。
:cmt :MSGATTR. 0
:cmt  Argument number %d1 in the call to subprogram %s3 is a subroutine but
:cmt  was used as a function in subprogram %s3.
:MSGSYM. UNUSED AR_PARM_COUNT
:cmt :MSGTXT. number of arguments expected in call to %s1 was %d2, but found %d3
:cmt :MSGJTXT. %s1を呼び出す時の引数は%d2個でなければなりません。%d3個ありました。
:cmt :MSGATTR. 0
:cmt  The number of arguments in the call to subprogram %s1 was %d3 and does not
:cmt  match the definition of subprogram %s1 which was defined with %d2 arguments.
:MSGSYM. UNUSED AR_SUB_EXPECT
:cmt :MSGTXT. argument number %d1 (%s2) in call to %s3 - a function was passed but a subroutine was expected
:cmt :MSGJTXT. %s3をCALLする%d1番目の引数(%s2) - 関数が渡されましたが,ｻﾌﾞﾙｰﾁﾝでなければなりません。
:cmt :MSGATTR. 0
:cmt  Argument number %d1 in the call to subprogram %s3 is a function but
:cmt  was used as a subroutine in subprogram %s3.
:MSGSYM. UNUSED AR_TYP_MISMATCH
:cmt :MSGTXT. argument number %d1 (%s2) in call to %s3 - %s4 argument was passed but %s5 argument was expected
:cmt :MSGJTXT. %3をCALLする%d1番目の引数(%s2) - %s4引数が渡されましたが,%s5引数でなければなりません。
:cmt :MSGATTR. 0
:cmt  The type of argument number %d1 in the call to subprogram %s3 was %s4.
:cmt  The type of argument number %d1 was declared as %s5 in subprogram %s3.
:cmt  The number and types of actual and dummy arguments must match.
:MSGSYM. UNUSED AR_STRUCT_MISMATCH
:cmt :MSGTXT. argument number %d1 (%s2) in call to %s3 - type of structure passed does not match type of structure expected
:cmt :MSGJTXT. %s3をCALLする%d1番目の引数(%s2) - 渡された構造体の型は、期待される構造体の型と合っていません。
:cmt :MSGATTR. 0
:cmt  The structure type of argument number %d1 in the call to subprogram
:cmt  %s3 does not match the expected structure type.
:cmt  Two structures are equivalent if the type of the corresponding field names
:cmt  are the same.
:cmt  Unions are considered equivalent if their sizes are the same.
:cmt  Field names, and the structure name itself, do not have to be the same.
:MSGSYM. UNUSED AR_PASS_BY_MISMATCH
:cmt :MSGTXT. argument number %d1 (%s2) in call to %s3 - argument passed by value but expected by reference
:cmt :MSGJTXT. %s3をCALLする%d1番目の引数(%s2) - 値渡しの引数ですが,ｱﾄﾞﾚｽ渡しでなければなりません。
:cmt :MSGATTR. 0
:cmt  Argument number %d1 in the call to subprogram %s3 was passed by value.
:cmt  The called subprogram expected the address of the argument instead of its
:cmt  value.
