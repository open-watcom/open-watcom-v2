...
extern  void            XLEqv(ftn_type *,const ftn_type *);
extern  void            XLNeqv(ftn_type *,const ftn_type *);
extern  void            XLOr(ftn_type *,const ftn_type *);
extern  void            XLAnd(ftn_type *,const ftn_type *);
extern  void            XLNot(ftn_type *,const ftn_type *);
extern  void            XBitEqv(ftn_type *,const ftn_type *);
extern  void            XBitNeqv(ftn_type *,const ftn_type *);
extern  void            XBitOr(ftn_type *,const ftn_type *);
extern  void            XBitAnd(ftn_type *,const ftn_type *);
extern  void            XBitNot(ftn_type *,const ftn_type *);
extern  void            XICmp(ftn_type *,const ftn_type *,const logstar1 *);
extern  void            XRCmp(ftn_type *,const ftn_type *,const logstar1 *);
extern  void            XDCmp(ftn_type *,const ftn_type *,const logstar1 *);
extern  void            XECmp(ftn_type *,const ftn_type *,const logstar1 *);
extern  void            XCCmp(ftn_type *,const ftn_type *,const logstar1 *);
extern  void            XQCmp(ftn_type *,const ftn_type *,const logstar1 *);
extern  void            XXCmp(ftn_type *,const ftn_type *,const logstar1 *);
extern  void            XChCmp(ftn_type *,const ftn_type *,const logstar1 *);
