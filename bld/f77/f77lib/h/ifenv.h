...
single AINT( single arg );
single XAINT( single *arg );
single ANINT( single arg );
single XANINT( single *arg );
single ACOS( single arg );
single XACOS( single *arg );
double DACOS( double arg );
double XDACOS( double *arg );
extended QACOS( extended arg );
extended XQACOS( extended *arg );
single COS( single arg );
single XCOS( single *arg );
double DCOS( double arg );
double XDCOS( double *arg );
extended QCOS( extended arg );
...
xcomplex CQCOS( extended rp, extended ip );
xcomplex XCQCOS( xcomplex *arg );
single COSH( single arg );
single XCOSH( single *arg );
double DCOSH( double arg );
double XDCOSH( double *arg );
extended QCOSH( extended arg );
extended XQCOSH( extended *arg );
single EXP( single arg );
single XEXP( single *arg );
double DEXP( double arg );
double XDEXP( double *arg );
extended QEXP( extended arg );
...
xcomplex CQLOG( extended rp, extended ip );
xcomplex XCQLOG( xcomplex *arg );
double DDIM( double arg1, double arg2 );
double XDDIM( double *arg1, double *arg2 );
extended QDIM( extended arg1, extended arg2 );
extended XQDIM( extended *arg1, extended *arg2 );
single DIM( single arg1, single arg2 );
single XDIM( single *arg1, single *arg2 );
double DINT( double arg );
double XDINT( double *arg );
extended QINT( extended arg );
extended XQINT( extended *arg );
double DNINT( double arg );
double XDNINT( double *arg );
extended QNINT( extended arg );
extended XQNINT( extended *arg );
double DSIGN( double arg1, double arg2 );
double XDSIGN( double *arg1, double *arg2 );
extended QSIGN( extended arg1, extended arg2 );
extended XQSIGN( extended *arg1, extended *arg2 );
intstar1 I1DIM( intstar1 arg1, intstar1 arg2 );
intstar1 XI1DIM( intstar1 *arg1, intstar1 *arg2 );
intstar2 I2DIM( intstar2 arg1, intstar2 arg2 );
...
intstar4 IDNINT( double arg );
intstar4 XIDNINT( double *arg );
intstar4 IQNINT( extended arg );
...
intstar4 ISIGN( intstar4 arg1, intstar4 arg2 );
...
logstar4 LLE( string PGM *arg1, string PGM *arg2 );
logstar4 LLT( string PGM *arg1, string PGM *arg2 );
intstar4 NINT( single arg );
...
intstar1 I1SHA( intstar1 arg1, intstar1 arg2 );
...
intstar1 I1SHFT( unsigned_8 arg1, intstar1 arg2 );
intstar1 XI1SHFT( unsigned_8 *arg1, intstar1 *arg2 );
intstar1 I1SHL( unsigned_8 arg1, intstar1 arg2 );
intstar1 XI1SHL( unsigned_8 *arg1, intstar1 *arg2 );
intstar2 I2SHA( intstar2 arg1, intstar2 arg2 );
...
intstar2 I2SHFT( unsigned_16 arg1, intstar2 arg2 );
intstar2 XI2SHFT( unsigned_16 *arg1, intstar2 *arg2 );
intstar2 I2SHL( unsigned_16 arg1, intstar2 arg2 );
intstar2 XI2SHL( unsigned_16 *arg1, intstar2 *arg2 );
intstar4 ISHL( unsigned_32 arg1, intstar4 arg2 );
intstar4 XISHL( unsigned_32 *arg1, intstar4 *arg2 );
intstar4 ISHA( intstar4 arg1, intstar4 arg2 );
...
intstar4 ISHFT( unsigned_32 arg1, intstar4 arg2 );
intstar4 XISHFT( unsigned_32 *arg1, intstar4 *arg2 );
intstar1 I1LSHIFT( intstar1 arg1, unsigned_8 arg2 );
intstar1 XI1LSHIFT( intstar1 *arg1, unsigned_8 *arg2 );
intstar1 I1RSHIFT( intstar1 arg1, unsigned_8 arg2 );
intstar1 XI1RSHIFT( intstar1 *arg1, unsigned_8 *arg2 );
intstar2 I2LSHIFT( intstar2 arg1, unsigned_16 arg2 );
intstar2 XI2LSHIFT( intstar2 *arg1, unsigned_16 *arg2 );
intstar2 I2RSHIFT( intstar2 arg1, unsigned_16 arg2 );
intstar2 XI2RSHIFT( intstar2 *arg1, unsigned_16 *arg2 );
intstar4 LSHIFT( intstar4 arg1, unsigned_32 arg2 );
intstar4 XLSHIFT( intstar4 *arg1, unsigned_32 *arg2 );
intstar4 RSHIFT( intstar4 arg1, unsigned_32 arg2 );
intstar4 XRSHIFT( intstar4 *arg1, unsigned_32 *arg2 );
intstar1 I1BCHNG( intstar1 arg1, intstar1 arg2 );
intstar1 XI1BCHNG( intstar1 *arg1, intstar1 *arg2 );
intstar2 I2BCHNG( intstar2 arg1, intstar2 arg2 );
intstar2 XI2BCHNG( intstar2 *arg1, intstar2 *arg2 );
intstar4 IBCHNG( intstar4 arg1, intstar4 arg2 );
...
double CDABS( double rp, double ip );
double XCDABS( dcomplex *arg );
extended CQABS( extended rp, extended ip );
...
intstar1 I1ABS( intstar1 arg );
intstar1 XI1ABS( intstar1 *arg );
intstar2 I2ABS( intstar2 arg );
intstar2 XI2ABS( intstar2 *arg );
intstar4 IABS( intstar4 arg );
intstar4 XIABS( intstar4 *arg );
single ABS( single arg );
...
intstar2 I2MOD( intstar2 arg1, intstar2 arg2 );
...
single AMOD( single arg1, single arg2 );
single XAMOD( single *arg1, single *arg2 );
double DMOD( double arg1, double arg2 );
...
logstar4 BTEST( intstar4 arg1, intstar4 arg2 );
logstar4 XBTEST( intstar4 *arg1, intstar4 *arg2 );
intstar1 I1BSET( intstar1 arg1, intstar1 arg2 );
intstar1 XI1BSET( intstar1 *arg1, intstar1 *arg2 );
intstar2 I2BSET( intstar2 arg1, intstar2 arg2 );
intstar2 XI2BSET( intstar2 *arg1, intstar2 *arg2 );
intstar4 IBSET( intstar4 arg1, intstar4 arg2 );
intstar4 XIBSET( intstar4 *arg1, intstar4 *arg2 );
intstar1 I1BCLR( intstar1 arg1, intstar1 arg2 );
intstar1 XI1BCLR( intstar1 *arg1, intstar1 *arg2 );
intstar2 I2BCLR( intstar2 arg1, intstar2 arg2 );
intstar2 XI2BCLR( intstar2 *arg1, intstar2 *arg2 );
intstar4 IBCLR( intstar4 arg1, intstar4 arg2 );
intstar4 XIBCLR( intstar4 *arg1, intstar4 *arg2 );
intstar4 IOR( intstar4 arg1, intstar4 arg2 );
intstar4 XIOR( intstar4 *arg1, intstar4 *arg2 );
intstar1 I1AND( intstar1 arg1, intstar1 arg2 );
intstar1 XI1AND( intstar1 *arg1, intstar1 *arg2 );
intstar2 I2AND( intstar2 arg1, intstar2 arg2 );
intstar2 XI2AND( intstar2 *arg1, intstar2 *arg2 );
intstar4 IAND( intstar4 arg1, intstar4 arg2 );
intstar4 XIAND( intstar4 *arg1, intstar4 *arg2 );
intstar1 I1OR( intstar1 arg1, intstar1 arg2 );
intstar1 XI1OR( intstar1 *arg1, intstar1 *arg2 );
intstar2 I2OR( intstar2 arg1, intstar2 arg2 );
intstar2 XI2OR( intstar2 *arg1, intstar2 *arg2 );
intstar4 IOR( intstar4 arg1, intstar4 arg2 );
intstar4 XIOR( intstar4 *arg1, intstar4 *arg2 );
intstar1 I1NOT( intstar1 arg1 );
intstar1 XI1NOT( intstar1 *arg1 );
intstar2 I2NOT( intstar2 arg1 );
intstar2 XI2NOT( intstar2 *arg1 );
intstar4 NOT( intstar4 arg1 );
intstar4 XNOT( intstar4 *arg1 );
intstar1 I1EOR( intstar1 arg1, intstar1 arg2 );
intstar1 XI1EOR( intstar1 *arg1, intstar1 *arg2 );
intstar2 I2EOR( intstar2 arg1, intstar2 arg2 );
intstar2 XI2EOR( intstar2 *arg1, intstar2 *arg2 );
intstar4 IEOR( intstar4 arg1, intstar4 arg2 );
intstar4 XIEOR( intstar4 *arg1, intstar4 *arg2 );
single TAN( single arg );
single XTAN( single *arg );
double DTAN( double arg );
double XDTAN( double *arg );
extended QTAN( extended arg );
extended XQTAN( extended *arg );
single ATAN( single arg );
single XATAN( single *arg );
double DATAN( double arg );
double XDATAN( double *arg );
extended QATAN( extended arg );
extended XQATAN( extended *arg );
single TANH( single arg );
single XTANH( single *arg );
double DTANH( double arg );
double XDTANH( double *arg );
extended QTANH( extended arg );
...
extended QCOTAN( extended arg );
extended XQCOTAN( extended *arg );
single ATAN2( single arg1, single arg2 );
single XATAN2( single *arg1, single *arg2 );
double DATAN2( double arg1, double arg2 );
double XDATAN2( double *arg1, double *arg2 );
extended QATAN2( extended arg1, extended arg2 );
extended XQATAN2( extended *arg1, extended *arg2 );
single ALOG( single arg );
single XALOG( single *arg );
double DLOG( double arg );
double XDLOG( double *arg );
extended QLOG( extended arg );
extended XQLOG( extended *arg );
scomplex CLOG( single rp, single ip );
scomplex XCLOG( scomplex *arg );
dcomplex CDLOG( double rp, double ip );
dcomplex XCDLOG( dcomplex *arg );
xcomplex CQLOG( extended rp, extended ip );
xcomplex XCQLOG( xcomplex *arg );
single ALOG10( single arg );
single XALOG10( single *arg );
double DLOG10( double arg );
double XDLOG10( double *arg );
extended QLOG10( extended arg );
extended XQLOG10( extended *arg );
single AMAX0( intstar4 arg1, intstar4 arg2 );
single AMAX1( single arg1, single arg2 );
double DMAX1( double arg1, double arg2 );
extended QMAX1( extended arg1, extended arg2 );
intstar1 I1MAX0( intstar1 arg1, intstar1 arg2 );
intstar2 I2MAX0( intstar2 arg1, intstar2 arg2 );
intstar4 MAX0( intstar4 arg1, intstar4 arg2 );
intstar4 MAX1( single arg1, single arg2 );
single XAMAX0( int num_args, ... );
single XAMAX1( int num_args, ... );
double XDMAX1( int num_args, ... );
extended XQMAX1( int num_args, ... );
intstar1 XI1MAX0( int num_args, ... );
intstar2 XI2MAX0( int num_args, ... );
intstar4 XMAX0( int num_args, ... );
intstar4 XMAX1( int num_args, ... );
single AMIN0( intstar4 arg1, intstar4 arg2 );
single AMIN1( single arg1, single arg2 );
double DMIN1( double arg1, double arg2 );
intstar1 I1MIN0( intstar1 arg1, intstar1 arg2 );
intstar2 I2MIN0( intstar2 arg1, intstar2 arg2 );
intstar4 MIN0( intstar4 arg1, intstar4 arg2 );
intstar4 MIN1( single arg1, single arg2 );
extended QMIN1( extended arg1, extended arg2 );
single XAMIN0( int num_args, ... );
single XAMIN1( int num_args, ... );
double XDMIN1( int num_args, ... );
intstar1 XI1MIN0( int num_args, ... );
intstar2 XI2MIN0( int num_args, ... );
intstar4 XMIN0( int num_args, ... );
intstar4 XMIN1( int num_args, ... );
