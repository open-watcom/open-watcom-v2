...
C
      OPEN( UNIT=I01, FILE='fm906.dat', STATUS='OLD', ACTION='READ',
     &      IOSTAT=ISTAT )
      IF( ISTAT .NE. 0 )THEN
         WRITE( I02, * )'Fatal Error opening FM906.DAT'
         STOP
      END IF
C-----------------------------------------------------------------------
C                                                                       00910906
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)05560906
