...
C
      OPEN( UNIT=I01, FILE='fm901.dat', STATUS='OLD', ACTION='READ',
     &      IOSTAT=ISTAT )
      IF( ISTAT .NE. 0 )THEN
         WRITE( I02, * )'Fatal Error opening FM901.DAT'
         STOP
      END IF
C-----------------------------------------------------------------------
C                                                                       00940901
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)02830901
