...
C****                                                                   00930110
     ...
     1          ZNAME*20, ZTAPE*10, ZPROJ*13, ZTAPED*13                 00950110
...
C
      OPEN( UNIT=I01, FILE='fm110.dat', STATUS='OLD', ACTION='READ',
     &      IOSTAT=ISTAT )
      IF( ISTAT .NE. 0 )THEN
         WRITE( I02, * )'Fatal Error opening FM110.DAT'
         STOP
      END IF
C-----------------------------------------------------------------------
C                                                                       01310110
...
90006 FORMAT (1H ,20X,46HNATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY)06160110
