...
/*
 * ====================================================================
 * OS2 cover functions for running under DOS
 * ====================================================================
 */
...
pasrtn DosChgFilePtr( int hdl, long unsigned offset, int typ,
