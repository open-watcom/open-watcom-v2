...
int getrec( char **pbuf, size_t *pbufsize, bool isrecord )    /* get next input record */
...
int readrec( char **pbuf, size_t *pbufsize, FILE *inf )  /* read one record into buf */
{
    int sep, c;
    char *rr, *buf = *pbuf;
    size_t bufsize = *pbufsize;
