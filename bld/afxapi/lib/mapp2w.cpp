...
*  ========================================================================
*
* Description:  Implementation of CMapPtrToWord.
*
****************************************************************************/
...
void CMapPtrToWord::GetNextAssoc( POSITION &rNextPosition, void *&rKey,
                                  WORD &rValue ) const
/****************************************************/
{
...
UINT CMapPtrToWord::HashKey( void *key ) const
/********************************************/
{
    return( (UINT)key >> 4 );
}

void CMapPtrToWord::InitHashTable( UINT hashSize, BOOL bAllocNow )
/****************************************************************/
{
    CAssoc  *pAssoc;
    CAssoc  *pNextAssoc;
