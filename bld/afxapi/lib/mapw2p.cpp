...
*  ========================================================================
*
* Description:  Implementation of CMapWordToPtr.
*
****************************************************************************/
...
void CMapWordToPtr::GetNextAssoc( POSITION &rNextPosition, WORD &rKey,
                                  void *&rValue ) const
/*****************************************************/
{
...
UINT CMapWordToPtr::HashKey( WORD key ) const
/*******************************************/
{
    return( key >> 4 );
}

void CMapWordToPtr::InitHashTable( UINT hashSize, BOOL bAllocNow )
/****************************************************************/
{
    CAssoc  *pAssoc;
    CAssoc  *pNextAssoc;
