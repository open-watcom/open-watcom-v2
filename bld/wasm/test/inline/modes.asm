...
mov eax,dword ptr +0H[ebp+eax]
mov eax,dword ptr +0H[ebp+ebx]
mov eax,dword ptr +0H[ebp+ecx]
mov eax,dword ptr +0H[ebp+edx]
mov eax,dword ptr +0H[ebp+esi]
mov eax,dword ptr +0H[ebp+edi]
mov eax,dword ptr +0H[ebp+ebp]
