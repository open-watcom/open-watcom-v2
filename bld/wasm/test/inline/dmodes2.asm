...
mov edx,dword ptr [edi+edi*4]
mov edx,dword ptr [edi+ebp*4]
mov edx,dword ptr [esp+eax*4]
mov edx,dword ptr [esp+ebx*4]
mov edx,dword ptr [esp+ecx*4]
mov edx,dword ptr [esp+edx*4]
mov edx,dword ptr [esp+esi*4]
mov edx,dword ptr [esp+edi*4]
mov edx,dword ptr [esp+ebp*4]
mov edx,dword ptr +0H[ebp+eax*4]
mov edx,dword ptr +0H[ebp+ebx*4]
mov edx,dword ptr +0H[ebp+ecx*4]
mov edx,dword ptr +0H[ebp+edx*4]
mov edx,dword ptr +0H[ebp+esi*4]
mov edx,dword ptr +0H[ebp+edi*4]
mov edx,dword ptr +0H[ebp+ebp*4]
