...
mov eax,dword ptr [edx+edx*4]
mov eax,dword ptr [edx+esi*4]
mov eax,dword ptr [edx+edi*4]
mov eax,dword ptr [edx+ebp*4]
mov eax,dword ptr [ebx+eax*4]
mov eax,dword ptr [ebx+ebx*4]
...
mov eax,dword ptr [esp+edi*4]
mov eax,dword ptr [esp+ebp*4]
mov eax,dword ptr +0H[ebp+eax*4]
mov eax,dword ptr +0H[ebp+ebx*4]
mov eax,dword ptr +0H[ebp+ecx*4]
mov eax,dword ptr +0H[ebp+edx*4]
mov eax,dword ptr +0H[ebp+esi*4]
mov eax,dword ptr +0H[ebp+edi*4]
mov eax,dword ptr +0H[ebp+ebp*4]
