...
mov edx,dword ptr +0H[ebp+eax*8]
mov edx,dword ptr +0H[ebp+ebx*8]
mov edx,dword ptr +0H[ebp+ecx*8]
mov edx,dword ptr +0H[ebp+edx*8]
mov edx,dword ptr +0H[ebp+esi*8]
mov edx,dword ptr +0H[ebp+edi*8]
mov edx,dword ptr +0H[ebp+ebp*8]
