...
CGAPIDEF( DBBegName,    dbg_name,       (char_ptr,dbg_type) )
...
CGAPIDEF( DBBegNameStruct,dbg_struct,   (char_ptr,cg_type,bool) )
...
CGAPIDEF( DBAddConst,   void,           (dbg_enum,char_ptr,signed_32) )
CGAPIDEF( DBAddConst64, void,           (dbg_enum,char_ptr,signed_64) )
