...
CGCALLBACKDEF( FEName,          char_ptr,       (cg_sym_handle) )
...
CGCALLBACKDEF( FEGenProc,       void,           (cg_sym_handle,pointer) )
...
CGCALLBACKDEF( FEGetEnv,        char_ptr,       (cchar_ptr) )
CGCALLBACKDEF( FEExtName,       char_ptr,       (cg_sym_handle,int) )
