...
extern tn           TGIndex( tn left, tn rite, const type_def *tipe, const type_def *ptipe );
extern tn           DoTGAssign( tn dst, tn src, const type_def *tipe, tn_class class );
extern tn           TGAssign( tn dst, tn src, const type_def *tipe );
extern tn           TGLVAssign( tn dst, tn src, const type_def *tipe );
...
extern tn           TGQuestion( tn sel, tn left, tn rite, const type_def *tipe );
...
extern tn           TName( name *name, const type_def *tipe );
