...
PICK(  PARENTHESIS,      SLACK_19,          ,        STR2,  "OOPS!", 0,  NONE                 )   /* optimization control - NOP for now */
...
PICK(  INTERNAL_10,      PARM_DEF,          ,        STR2,  "parm ", 0,  NONE                 )   /* CGAddParm() */
PICK(  INTERNAL_11,      SELECT,            ,        STR2,  "sel  ", 1,  NONE                 )   /* generalized jump */
...
PICK(  INTERNAL_21,      DEBUG_INFO,        ,        STR2,  "dinfo", 0,  NONE                 )
PICK(  INTERNAL_22,      CHEAP_NOP,         ,        STR2,  "cnop ", 0,  NONE                 )
PICK(  INTERNAL_23,      LOAD_UNALIGNED,    ,        STR2,  "ldq_u", 1,  NONE                 )
PICK(  INTERNAL_24,      STORE_UNALIGNED,   ,        STR2,  "stq_u", 1,  NONE                 )
PICK(  INTERNAL_25,      EXTRACT_LOW,       ,        STR2,  "extl ", 2,  NONE                 )
PICK(  INTERNAL_26,      EXTRACT_HIGH,      ,        STR2,  "exth ", 2,  NONE                 )
PICK(  INTERNAL_27,      INSERT_LOW,        ,        STR2,  "insl ", 2,  NONE                 )
PICK(  INTERNAL_28,      INSERT_HIGH,       ,        STR2,  "insh ", 2,  NONE                 )
PICK(  INTERNAL_29,      MASK_LOW,          ,        STR2,  "mskl ", 2,  NONE                 )
PICK(  INTERNAL_30,      MASK_HIGH,         ,        STR2,  "mskh ", 2,  NONE                 )
PICK(  INTERNAL_31,      ZAP,               ,        STR2,  "zap  ", 2,  NONE                 )
PICK(  INTERNAL_32,      ZAP_NOT,           ,        STR2,  "zap! ", 2,  NONE                 )
PICK(  STACK_ALLOC,      STACK_ALLOC,       ,        STR2,  "alloc", 0,  NONE                 )
PICK(  VA_START,         VA_START,          ,        STR2,  "vastr", 1,  NONE                 )
                                                                     
/*  Slack */                                                         
                                                                     
PICK(  SLACK_31,         SLACK_31,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_32,         SLACK_32,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_33,         SLACK_33,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_34,         SLACK_34,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_35,         SLACK_35,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_36,         SLACK_36,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_37,         SLACK_37,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_38,         SLACK_38,          ,        STR2,  "OOPS!", 0,  NONE                 )
PICK(  SLACK_39,         SLACK_39,          ,        STR2,  "OOPS!", 0,  NONE                 )

/*  Internal */

PICK(  INTERNAL_33,      BLOCK,             ,        STR2,  "BLOCK", 0,  NONE                 )
...
PICK( FLOW_AND,          ,                  "&&",    STR1,         , 0,  NONE                 )
PICK( FLOW_OR,           ,                  "||",    STR1,         , 0,  NONE                 )
PICK( FLOW_OUT,          ,                  ,        STR2,         , 0,  NONE                 )
PICK( FLOW_NOT,          ,                  "!",     STR1,         , 0,  NONE                 )
                                                                                              
PICK( POINTS,            ,                  "@",     STR1,         , 0,  NONE                 )   /* CGUnary() */

/* % Control operators -- call CGControl(),CGBigGoto(),CGBigLabel() */

PICK( GOTO,              ,                  ,        STR2,         , 0,  NONE                 )
PICK( BIG_GOTO,          ,                  ,        STR2,         , 0,  NONE                 )
PICK( IF_TRUE,           ,                  ,        STR2,         , 0,  NONE                 )
PICK( IF_FALSE,          ,                  ,        STR2,         , 0,  NONE                 )
PICK( INVOKE_LABEL,      ,                  ,        STR2,         , 0,  NONE                 )
PICK( LABEL,             ,                  ,        STR2,         , 0,  NONE                 )
PICK( BIG_LABEL,         ,                  ,        STR2,         , 0,  NONE                 )
PICK( LABEL_RETURN,      ,                  ,        STR2,         , 0,  NONE                 )

PICK( PROC,              ,                  ,        STR2,         , 0,  NONE                 )   /* CGProcDecl */
PICK( PARM_DEF,          ,                  ,        STR2,         , 0,  NONE                 )   /* CGParmDecl */
PICK( AUTO_DEF,          ,                  ,        STR2,         , 0,  NONE                 )   /* CGAutoDecl */
PICK( COMMA,             ,                  ,        STR2,         , 0,  NONE                 )

PICK( PASS_PROC_PARM,    ,                  ,        STR2,         , 0,  NONE                 )   /* CGPassPP */
PICK( DEFN_PROC_PARM,    ,                  ,        STR2,         , 0,  NONE                 )   /* CGDeclPP */
PICK( CALL_PROC_PARM,    ,                  ,        STR2,         , 0,  NONE                 )   /* CGCallPP */

PICK( PRE_GETS,          ,                  ,        STR2,         , 0,  NONE                 )   /* CGPreGets, CGLVPreGets */
PICK( POST_GETS,         ,                  ,        STR2,         , 0,  NONE                 )   /* CGPostGets */

PICK( SIDE_EFFECT,       ,                  ,        STR2,         , 0,  NONE                 )
