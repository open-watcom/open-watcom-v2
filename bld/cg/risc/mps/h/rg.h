...
RG( RL_QWORD,  RL_QWORD,  RL_FLOAT,  RL_,    RL_,      RG_QF ),
RG( RL_QWORD,  RL_QWORD,  RL_FLOAT,  RL_,    RL_FLOAT, RG_QF_NEED ),
RG( RL_FLOAT,  RL_FLOAT,  RL_QWORD,  RL_,    RL_,      RG_FQ ),
RG( RL_FLOAT,  RL_FLOAT,  RL_QWORD,  RL_,    RL_FLOAT, RG_FQ_NEED ),
