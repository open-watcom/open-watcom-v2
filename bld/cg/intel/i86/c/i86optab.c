...
ADD1 ,ADD1 ,ADD2 ,ADD2 ,ADD4 ,ADD4 ,ADD8 ,ADD8 ,ADDCP,ADDPT,RTN4FC,RTN8C,RTN10C,__X__,/* OP_ADD */
__X__,__X__,EADD ,EADD ,__X__,__X__,__X__,__X__,__X__,__X__,__X__ ,__X__,__X__ ,__X__,/* OP_EXT_ADD */
SUB1 ,SUB1 ,SUB2 ,SUB2 ,SUB4 ,SUB4 ,SUB8 ,SUB8 ,SUBCP,SUBPT,RTN4F ,RTN8 ,RTN10 ,__X__,/* OP_SUB */
__X__,__X__,ESUB ,ESUB ,__X__,__X__,__X__,__X__,__X__,__X__,__X__ ,__X__,__X__ ,__X__,/* OP_EXT_SUB */
MUL1 ,MUL1 ,MUL2 ,MUL2 ,RTN4C,RTN4C,SUPP8,SUPP8,__X__,__X__,RTN4FC,RTN8C,RTN10C,__X__,/* OP_MUL */
__X__,__X__,EMUL ,EMUL ,EMUL ,EMUL ,__X__,__X__,__X__,__X__,__X__ ,__X__,__X__ ,__X__,/* OP_EXT_MUL */
DIV1 ,DIV1 ,DIV2 ,DIV2 ,RTN4 ,RTN4 ,SUPP8,SUPP8,__X__,__X__,RTN4F ,RTN8 ,RTN10 ,__X__,/* OP_DIV */
MOD1 ,MOD1 ,MOD2 ,MOD2 ,RTN4 ,RTN4 ,SUPP8,SUPP8,__X__,__X__,RTN4F ,RTN8 ,RTN10 ,__X__,/* OP_MOD */
...
__X__,__X__,__X__,__X__,__X__,RTN4 ,__X__,SUPP8,__X__,__X__,BFUNS ,BFUND,BFUNL ,__X__,/* OP_POW */
...
MOV1 ,MOV1 ,MOV2 ,MOV2 ,MOV4 ,MOV4 ,MOV8 ,MOV8 ,MOV4 ,MOV4 ,MOVFS ,MOVFD,MOVFL ,MOVX ,/* OP_MOV */
CALLI,CALLI,CALLI,CALLI,CALLI,CALLI,CALLI,CALLI,CALLI,CALLI,CALLI ,CALLI,CALLI ,CALLI,/* OP_CALL_INDI */
PUSH1,PUSH1,PUSH2,PUSH2,PUSH4,PUSH4,PUSH8,PUSH8,PUSH4,PUSH4,PSHFS ,PSHFD,PSHFL ,PUSHX,/* OP_PUSH */
...
TEST1,TEST1,TEST2,TEST2,TEST4,TEST4,TEST8,TEST8,__X__,__X__,__X__ ,__X__,__X__ ,__X__,/* OP_BIT_TEST_ */
CMP1 ,CMP1 ,CMP2 ,CMP2 ,CMP4 ,CMP4 ,CMP8 ,CMP8 ,CMPCP,CMPPT,CMPF  ,CMPD ,CMPL  ,__X__,/* OP_CMP_EQUAL */
CMP1 ,CMP1 ,CMP2 ,CMP2 ,CMP4 ,CMP4 ,CMP8 ,CMP8 ,CMPCP,CMPPT,CMPF  ,CMPD ,CMPL  ,__X__,/* OP_CMP_NOT_E */
CMP1 ,CMP1 ,CMP2 ,CMP2 ,CMP4 ,CMP4 ,CMP8 ,CMP8 ,CMPCP,CMPPT,CMPF  ,CMPD ,CMPL  ,__X__,/* OP_CMP_GREAT */
CMP1 ,CMP1 ,CMP2 ,CMP2 ,CMP4 ,CMP4 ,CMP8 ,CMP8 ,CMPCP,CMPPT,CMPF  ,CMPD ,CMPL  ,__X__,/* OP_CMP_LESS_ */
CMP1 ,CMP1 ,CMP2C,CMP2C,CMP4C,CMP4C,CMP8 ,CMP8 ,CMPCP,CMPPT,CMPF  ,CMPD ,CMPL  ,__X__,/* OP_CMP_LESS */
CMP1 ,CMP1 ,CMP2C,CMP2C,CMP4C,CMP4C,CMP8 ,CMP8 ,CMPCP,CMPPT,CMPF  ,CMPD ,CMPL  ,__X__,/* OP_CMP_GREAT */
