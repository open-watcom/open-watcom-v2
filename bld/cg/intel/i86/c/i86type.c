...
//const type_def THugeCP= {  TY_LONG_CODE_PTR,  4,      TYPE_POINTER + TYPE_CODE };
const type_def TLongCP = { TY_LONG_CODE_PTR,  4,      TYPE_POINTER + TYPE_CODE };
const type_def TNearCP = { TY_NEAR_CODE_PTR,  2,      TYPE_POINTER + TYPE_CODE };
const type_def THugeP  = { TY_HUGE_POINTER,   4,      TYPE_POINTER };
const type_def TLongP  = { TY_LONG_POINTER,   4,      TYPE_POINTER };
const type_def TNearP  = { TY_NEAR_POINTER,   2,      TYPE_POINTER };
...
/**************************/
{
    ...
    if( _IsTargetModel( CGSW_X86_BIG_DATA ) ) {
        if( _IsTargetModel( CGSW_X86_CHEAP_POINTER ) ) {
