...
static const opcode_defs G1Index[] = {
        OP_ADD,
        OP_EXT_ADD,
        OP_SUB,
        OP_EXT_SUB,
...
static const gen_opcode G1Opcodes[] = {
...
static const opcode_defs G2Index[] = {
        OP_PUSH, OP_POP, OP_ADD, OP_SUB };

static const gen_opcode G2Opcodes[] = {
        M_PUSH, M_POP, 0x40,   0x48 };

static const opcode_defs G3Index[] = {
        OP_ADD,
        OP_SUB,
        OP_MUL,
        OP_EXT_MUL,
...
static const gen_opcode G3Opcodes[] = {
/*       R1      M1      R2      M2*/
...
static const opcode_defs G4Index[] = {
        OP_RSHIFT,
        OP_LSHIFT };

static const gen_opcode G4Opcodes[] = {
...
static const gen_opcode G9Opcodes[] = {
...
static const opcode_defs NoIndex[] = {
        OP_NOP };               /* i.e. will match anything*/

const pccode_def PCCodeTable[] = {
