...
#endif
_OE( _UnPP(  U,    M,    NONE ),       V_NO,           RG_8087_NEED_MOVE, G_UNKNOWN,      FU_NO ),
_OE( _UnPP(  R,    M,    NONE ),       V_NO,           RG_ST0_STI,        G_UNKNOWN,      FU_NO ),
_OE( _UnPP(  M|C,  U,    NONE ),       V_NO,           RG_8087_NEED_MOVE, G_UNKNOWN,      FU_NO ),
...
_OE( _UnPP(  R|M,  ANY,  NONE ),       V_NO,           RG_8087_NEED_MOVE, G_UNKNOWN,      FU_NO ),
_OE( _UnPP(  R,    R,    NONE ),       V_NO,           RG_ST0_STI,        G_UNKNOWN,      FU_NO ),
_OE( _UnPP(  ANY,  ANY,  NONE ),       V_NO,           RG_8087_NEED_MOVE, G_UNKNOWN,      FU_NO ),
