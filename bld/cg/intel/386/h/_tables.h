...
pick( CMPL,         CmpFL,      Cmp87      )
pick( MOV1,         Move1,      Move1      )
pick( MOV2,         Move2CC,    Move2CC    )
pick( MOV4,         Move4CC,    Move4CC    )
pick( MOVCP,        MoveCP,     MoveCP     )
pick( MOV8,         Move8,      Move8      )
pick( MOVX,         MoveXX,     MoveXX     )
pick( LACP,         LoadACP,    LoadACP    )
pick( LA,           LoadA,      LoadA      )
pick( NOT1,         Not1,       Not1       )
pick( NOT2,         Not2,       Not2       )
pick( NOT4,         Not4,       Not4       )
...
pick( RTNI8,        Rtn8,       Rtn8       )
pick( RTN10C,       Rtn10C,     Bin87      )
pick( RTN10,        Rtn10,      Bin87      )
pick( DONOTHING,    DoNop,      DoNop      )
pick( PUSHX,        PushXX,     PushXX     )
pick( MOVFS,        MoveFS,     Move87S    )
pick( MOVFD,        Move8,      Move87D    )
pick( MOVFL,        MoveFL,     Move87L    )
pick( PSHFS,        PushFS,     Push87S    )
pick( PSHFD,        Push8,      Push87D    )
pick( PSHFL,        PushFL,     Push87L    )
