...
static  struct STRUCT_byte_seq() Scn1ES = {
     6, FALSE,
    {0x06,          /*      push    es  */
     0x0e,          /*      push    cs  */
     0x07,          /*      pop     es  */
...
static  struct STRUCT_byte_seq() Scn2 = {    /* or Scn4 in USE16 */
     3, FALSE,
    {0xF2,          /*      repne       */
     0x66, 0xAF}    /*      scasw       */
};

static  struct STRUCT_byte_seq() Scn2ES = {  /* or Scn4 in USE16 */
     7, FALSE,
    {0x06,          /*      push    es  */
     0x0e,          /*      push    cs  */
     0x07,          /*      pop     es  */
...
static  struct STRUCT_byte_seq() Scn4 = {    /* or Scn2 in USE16 */
     2, FALSE,
    {0xF2,          /*      repne       */
     0xAF}          /*      scasd       */
};

static  struct STRUCT_byte_seq() Scn4ES = {  /* or Scn2 in USE16 */
     6, FALSE,
    {0x06,          /*      push    es  */
     0x0e,          /*      push    cs  */
     0x07,          /*      pop     es  */
