...
/*************************/
{
    ...
    do {
        ...
        for(;;) {
            ...
            c = next[ previous ];
            after_c = next[ c ];
            if( after_c == most_used_character ) break;
    ...
    do {
        ...
        if( works ) {
            ...
            do {
                ...
                if( c == most_used_character ) break;
                weights[ c ]++;
