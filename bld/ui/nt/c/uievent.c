...
static const map events[] = {
    ...
    { VK_LEFT, EV_CURSOR_LEFT, EV_SHIFT_CURSOR_LEFT, EV_CTRL_CURSOR_LEFT, EV_CURSOR_LEFT },
    { VK_UP, EV_CURSOR_UP, EV_SHIFT_CURSOR_UP, EV_CTRL_CURSOR_UP, EV_CURSOR_UP },
    { VK_RIGHT, EV_CURSOR_RIGHT, EV_SHIFT_CURSOR_RIGHT, EV_CTRL_CURSOR_RIGHT, EV_CURSOR_RIGHT },
    { VK_DOWN, EV_CURSOR_DOWN, EV_SHIFT_CURSOR_DOWN, EV_CTRL_CURSOR_DOWN, EV_CURSOR_DOWN },
