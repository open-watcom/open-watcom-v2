...
extern          void            uimenusetaltpressed ( int );
extern          void            uinomenus( void );
extern          void            uiactivatemenus( void );
extern          int             uienablemenuitem( unsigned, unsigned, int );
extern          void            uidescmenu( MENUITEM *, DESCMENU * );
extern          void            uidrawmenu( MENUITEM *, DESCMENU *, int );
extern          void            uidisplayitem( MENUITEM *, DESCMENU *, int, int );
extern          void            uiclosepopup( UI_WINDOW* );
extern          void            uiopenpopup( DESCMENU*, UI_WINDOW* );
extern          int             uiposfloatingpopup( MENUITEM *menu, DESCMENU *desc, ORD row, ORD col, SAREA *keep_inside, SAREA *keep_visible );
extern          EVENT           uicreatepopup( ORD row, ORD col, MENUITEM *menu, int left, int right, EVENT curr_item );
extern          EVENT           uicreatepopupdesc( MENUITEM *menu, DESCMENU *desc, int left, int right, EVENT curr_item, int sub );
extern          EVENT           uicreatepopupinarea( MENUITEM *menu, DESCMENU *desc, int left, int right, EVENT curr_item, SAREA *keep_inside, int sub );
extern          EVENT           uicreatesubpopup( MENUITEM *menu, DESCMENU *desc, int left, int right, EVENT curr_item, SAREA *keep_inside, DESCMENU *parent_menu, int index );
extern          EVENT           uicreatesubpopupinarea( MENUITEM *menu, DESCMENU *desc, int left, int right, EVENT curr_item, SAREA *keep_inside, SAREA *return_inside, SAREA *return_exclude );
