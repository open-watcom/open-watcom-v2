...
extern ui_event     uicreatepopup( ORD row, ORD col, UIMENUITEM *menuitems, bool left, bool right, ui_event curr_item );
extern ui_event     uicreatepopupdesc( UIMENUITEM *menuitems, DESCMENU *desc, bool left, bool right, ui_event curr_item, bool issubmenu );
extern ui_event     uicreatepopupinarea( UIMENUITEM *menuitems, DESCMENU *desc, bool left, bool right, ui_event curr_item, SAREA *keep_inside, bool issubmenu );
extern ui_event     uicreatesubpopup( UIMENUITEM *menuitems, DESCMENU *desc, bool left, bool right, ui_event curr_item, SAREA *keep_inside, DESCMENU *parentdesc, int index );
extern ui_event     uicreatesubpopupinarea( UIMENUITEM *menuitems, DESCMENU *desc, bool left, bool right, ui_event curr_item, SAREA *keep_inside, SAREA *return_inside, SAREA *return_exclude );
