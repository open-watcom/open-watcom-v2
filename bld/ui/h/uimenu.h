...
extern ui_event     uicreatepopupdesc( UIMENUITEM *menuitems, DESCMENU *desc, bool left, bool right, ui_event curr_item, bool sub );
extern ui_event     uicreatepopupinarea( UIMENUITEM *menuitems, DESCMENU *desc, bool left, bool right, ui_event curr_item, SAREA *keep_inside, bool sub );
