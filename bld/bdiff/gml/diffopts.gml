...
:title. Usage: bdiff <old_exe> <new_exe> <patch_file> [options]
:titleu. Usage: %C <old_exe> <new_exe> <patch_file> [options]
:target. any
...
:option. dn
:usage. new file's debug info
:file.
:target. any

:option. do
:usage. old file's debug info
:file.
:target. any

:option. l
:usage. don't write patch level into patch file
:target. any
