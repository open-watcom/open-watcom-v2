...
:cmt    :number. [<fn>] [<default>]             =<num> allowed; call <fn> to check
...
:option. Wn
:usage. enable warning message <n>
:group. 3
:number.
:target. any

:option. Wno-n
:usage. disable warning message <n>
:group. 3
:number.
:target. any
...
:usage. stop compiler after <n> errors
:group. 3
:number.
:target. any
