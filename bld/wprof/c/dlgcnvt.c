...
#define DLGCONVERT_CTLS() \
    pick_p5(   OUTFILEBOX,  DLG_BOX,            "Output File Name",     C0,   R0,   C1-C0-1, 3 ) \
    pick_p4id( NAME,        DLG_EDIT,           "",                     C0+1, R0+1, C1-C0-3 ) \
    pick_p4id( BROWSE,      DLG_BUTTON,         "&Browse ...",          C1,   R0+1, W-C1 ) \
    pick_p5(   FORMATBOX,   DLG_BOX,            "Format Type",          C0,   R1,   C1-C0-1, 4 ) \
    pick_p4id( DIF_FMT,     DLG_RADIO_START,    "&DIF Format",          C0+1, R1+1, C1-C0-3 ) \
    pick_p4id( COMMA_FMT,   DLG_RADIO_END,      "&Comma Format",        C0+1, R1+2, C1-C0-3 ) \
    pick_p4id( OK,          DLG_DEFBUTTON,      "OK",                   B1,   R2,   BW+1 ) \
    pick_p4id( DEFAULTS,    DLG_BUTTON,         "&Defaults",            B2,   R2,   BW+1 ) \
    pick_p4id( CANCEL,      DLG_BUTTON,         "Cancel",               B3,   R2,   BW+1 )
