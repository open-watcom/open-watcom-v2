...
/********************************/
{
    ...
    while( sio_rover != NULL ) {
        ...
        for( image_index = 0; image_index < sio_rover->image_count; ++image_index ) {
