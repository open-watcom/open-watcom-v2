...
char                    FNameBuff[_MAX_PATH2];

STATIC mod_info * findCurrMod( image_info *, mod_handle );
STATIC rtn_info * findCurrRtn( mod_info *, sym_handle * );
STATIC void loadSampleImages();
STATIC void initModuleInfo( image_info * );
STATIC void initFileInfo( mod_info * );
