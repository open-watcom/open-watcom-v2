...
signed   long long __far __based(__segname("FARAWAY")) s_store1;
signed   long long __far __based(__segname("FARAWAY")) s_store2;
unsigned long long __far __based(__segname("FARAWAY")) u_store1;
unsigned long long __far __based(__segname("FARAWAY")) u_store2;
...
signed   type __far __based(__segname("FARAWAY")) s_##type = d1;                 \
unsigned type __far __based(__segname("FARAWAY")) u_##type = d2;                 \
signed   type __far __based(__segname("FARAWAY")) sneg_##type = d3;              \
unsigned type __far __based(__segname("FARAWAY")) ubig_##type = d4;              \
signed   long long  s_expand_##type(signed   type __far *p)  { return *p; }      \
unsigned long long  u_expand_##type(unsigned type __far *p)  { return *p; }      \
void store_s_s_##type(signed   long long __far *p, signed   type n) { *p = n; }  \
void store_s_u_##type(signed   long long __far *p, unsigned type n) { *p = n; }  \
void store_u_s_##type(unsigned long long __far *p, signed   type n) { *p = n; }  \
void store_u_u_##type(unsigned long long __far *p, unsigned type n) { *p = n; }  \
