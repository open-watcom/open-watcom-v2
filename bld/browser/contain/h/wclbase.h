...
//
#pragma warning 549 9 // "Warning! W549: 'sizeof' operand contains compiler generated information"
...
protected:
    ...
    void            base_insert( WCSLink * );
    WCSLink *       base_next( const WCSLink *, WCbool ) const;
    ...
    int             base_index( const WCSLink * ) const;
