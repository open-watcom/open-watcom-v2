...
_WCRTLINK extern int        execv( const char *__path, char *const __argv[] );
_WCRTLINK extern int        execve( const char *__path, char *const __argv[], char *const __envp[] );
_WCRTLINK extern int        execvp( const char *__file, char *const __argv[] );
:endsegment
::
