...
[![Coverity-Scan](https://github.com/open-watcom/open-watcom-v2/actions/workflows/coverity.yml/badge.svg)](https://github.com/open-watcom/open-watcom-v2/actions/workflows/coverity.yml), [Github Build]([https://dev.azure.com/open-watcom/open-watcom-v2/_build/latest?definitionId=16&branchName=master](https://github.com/open-watcom/open-watcom-v2-CI-migration/actions/workflows/ow-v2-cov.yml)|
