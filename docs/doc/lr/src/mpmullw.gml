...
.arg m1
are multiplied with the respective signed or unsigned 16-bit words of
.arg m2
.ct .li .
The low-order 16-bits of each result are placed in the respective
...
.arg m2
and the low-order 16-bits of the results are returned.
.return end
.see begin
