...
.arg m2
are subtracted from the respective signed 8-bit bytes of
.arg m1
and the result is stored in memory.
Saturation occurs when a result exceeds the range of a
signed byte.
...
.desc end
.return begin
The result of subtracting the packed signed bytes, with saturation, of
