...
The
.id &func1.
&routine displays a multi-series bar, column or line chart.
The argument
.arg nseries
...
.return end
.see begin
.seelist _pg_defaultchart _pg_initchart _pg_chartpie _pg_chartscatter _pg_analyzechart _pg_analyzepie _pg_analyzescatter
.see end
