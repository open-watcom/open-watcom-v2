...
.do end
.*
.if '&'lower(&book)' eq 'ide' or &e'&allinone ne 0 .do begin
.sepsect &wide
:INCLUDE file='wguiwide.gml'
.do end
.if '&'lower(&book)' eq 'wbrw' or &e'&allinone ne 0 .do begin
.sepsect Browser
...
.if '&'lower(&book)' eq 'resedt' or &e'&allinone ne 0 .do begin
:INCLUDE file='wre.gml'
.do end
.if '&'lower(&book)' eq 'resacc' or &e'&allinone ne 0 .do begin
:INCLUDE file='wguiaccl.gml'
.do end
.if '&'lower(&book)' eq 'resdlg' or &e'&allinone ne 0 .do begin
:INCLUDE file='wguidlog.gml'
.do end
.if '&'lower(&book)' eq 'resimg' or &e'&allinone ne 0 .do begin
:INCLUDE file='wguimage.gml'
.do end
.if '&'lower(&book)' eq 'resmnu' or &e'&allinone ne 0 .do begin
:INCLUDE file='wguimenu.gml'
.do end
.if '&'lower(&book)' eq 'resstr' or &e'&allinone ne 0 .do begin
:INCLUDE file='wguistrg.gml'
.do end

.if '&'lower(&book)' eq 'rescomp' or &e'&allinone ne 0 .do begin
.sepsect Resource Compiler
:INCLUDE file='wrc.gml'
.do end
.if '&'lower(&book)' eq 'zoom' or &e'&allinone ne 0 .do begin
.sepsect Zoom
:INCLUDE file='wguizoom.gml'
.do end
.if '&'lower(&book)' eq 'heapwalk' or &e'&allinone ne 0 .do begin
.sepsect Heap Walker
:INCLUDE file='wguiheap.gml'.
.do end
.if '&'lower(&book)' eq 'spy' or &e'&allinone ne 0 .do begin
.sepsect Spy
:INCLUDE file='wguispy.gml'
.do end
.if '&'lower(&book)' eq 'ddespy' or &e'&allinone ne 0 .do begin
.sepsect DDE Spy
:INCLUDE file='wguidspy.gml'
.do end
.if '&'lower(&book)' eq 'drwatcom' or &e'&allinone ne 0 .do begin
.sepsect &drwc for Win16
.helppref Win16:
:INCLUDE file='wguidrwc.gml'
.helppref
.do end
.if '&'lower(&book)' eq 'drnt' or &e'&allinone ne 0 .do begin
