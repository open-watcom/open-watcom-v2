...
:CMT.                                       new technology
:CMT.   91/2/07    Jim Welch            For H2 ... changed pre_skip_tops to
:CMT.                                       pre_skips to remove white space
:CMT.                                       when sub-sections start at top
:CMT.                                       of pages; set pre_top_skip=0
:CMT.
:CMT.************************************************************
