...
c:
REM Change the path below to be appropriate for your system.
cd \OW\ow_release\1.0\rel2\binnt

ren CBOOKS.HLP cbooks.hlp
...
ren DRNT.HLP drnt.hlp
ren DRWATCOM.HLP drwatcom.hlp
ren EBOOKS.HLP ebooks.hlp
ren EDITOR.HLP editor.hlp
ren F77GRAPH.HLP f77graph.hlp
ren F77LR.HLP f77lr.hlp
...
ren RESEDT.HLP resedt.hlp
ren RESIMG.HLP resimg.hlp
...
ren WD.HLP wd.hlp
ren WFCERRS.HLP wfcerrs.hlp
ren WLNKERRS.HLP wlnkerrs.hlp
ren WPPERRS.HLP wpperrs.hlp
ren WPROF.HLP wprof.hlp
ren WRCERRS.HLP wrcerrs.hlp
ren ZOOM.HLP zoom.hlp
